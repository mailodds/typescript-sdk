...
import {
    ConnectDnsProviderRequestFromJSON,
    ConnectDnsProviderRequestToJSON,
    ErrorResponseFromJSON,
    ErrorResponseToJSON,
} from '../models/index';

export interface ConnectDnsProviderOperationRequest {
 ...
 * 
 */
export class DNSProviderApi extends runtime.BaseAPI {
     ...
     */
    async connectDnsProviderRaw(requestParameters: ConnectDnsProviderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['connectDnsProviderRequest'] == null) {
            throw new runtime.RequiredError(
                'connectDnsProviderRequest',
                'Required parameter "connectDnsProviderRequest" was null or undefined when calling connectDnsProvider().'
            );
        }
        ...
        let urlPath = `/v1/account/dns-provider`;
        ...
        const response = await this.request({
            ...
            body: ConnectDnsProviderRequestToJSON(requestParameters['connectDnsProviderRequest']),
        }, initOverrides);
     ...
     * Connect DNS provider
     */
    async connectDnsProvider(requestParameters: ConnectDnsProviderOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.connectDnsProviderRaw(requestParameters, initOverrides);
    }
     ...
     */
    async disconnectDnsProviderRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Disconnect DNS provider
     */
    async disconnectDnsProvider(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.disconnectDnsProviderRaw(initOverrides);
    }
     ...
     */
    async getDnsProviderRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Get DNS provider status
     */
    async getDnsProvider(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getDnsProviderRaw(initOverrides);
    }
