...
export interface DismissDeliverabilityRecommendationRequest {
 ...
 * 
 */
export class DeliverabilityAdvisorApi extends runtime.BaseAPI {

    /**
     * Dismiss a deliverability recommendation so it no longer appears.
     * Dismiss a deliverability recommendation
     */
    async dismissDeliverabilityRecommendationRaw(requestParameters: DismissDeliverabilityRecommendationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['recommendationId'] == null) {
            throw new runtime.RequiredError(
                'recommendationId',
                'Required parameter "recommendationId" was null or undefined when calling dismissDeliverabilityRecommendation().'
            );
        }
        ...
        let urlPath = `/v1/deliverability/recommendations/{recommendation_id}/dismiss`;
     ...
     * Dismiss a deliverability recommendation
     */
    async dismissDeliverabilityRecommendation(requestParameters: DismissDeliverabilityRecommendationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.dismissDeliverabilityRecommendationRaw(requestParameters, initOverrides);
    }
     ...
     */
    async getDeliverabilityRecommendationsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/deliverability/recommendations`;
     ...
     * Get deliverability recommendations
     */
    async getDeliverabilityRecommendations(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getDeliverabilityRecommendationsRaw(initOverrides);
    }
