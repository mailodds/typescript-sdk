...
import {
    ...
    ErrorResponseToJSON,
    GetMessageEvents200ResponseFromJSON,
    GetMessageEvents200ResponseToJSON,
} from '../models/index';

export interface GetMessageEventsRequest {
    messageId: string;
}
 ...
 * 
 */
export class MessageEventsApi extends runtime.BaseAPI {

    /**
     * Get delivery and engagement events for a specific sent message. Returns events in chronological order with bot detection.
     * Get message events
     */
    async getMessageEventsRaw(requestParameters: GetMessageEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMessageEvents200Response>> {
        if (requestParameters['messageId'] == null) {
            throw new runtime.RequiredError(
                'messageId',
                'Required parameter "messageId" was null or undefined when calling getMessageEvents().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetMessageEvents200ResponseFromJSON(jsonValue));
    }
     ...
     * Get message events
     */
    async getMessageEvents(requestParameters: GetMessageEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMessageEvents200Response> {
        const response = await this.getMessageEventsRaw(requestParameters, initOverrides);
