 ...
 * 
 */
export class SendingDelegationsApi extends runtime.BaseAPI {

    /**
     * Create a sending delegation granting another account permission to send from this domain.
     * Create a sending delegation
     */
    async createDelegationRaw(requestParameters: CreateDelegationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['domainId'] == null) {
            throw new runtime.RequiredError(
                'domainId',
                'Required parameter "domainId" was null or undefined when calling createDelegation().'
            );
        }
        ...
        let urlPath = `/v1/sending-domains/{domain_id}/delegations`;
     ...
     * Create a sending delegation
     */
    async createDelegation(requestParameters: CreateDelegationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.createDelegationRaw(requestParameters, initOverrides);
    }
     ...
     */
    async listDelegationsRaw(requestParameters: ListDelegationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['domainId'] == null) {
            throw new runtime.RequiredError(
                'domainId',
                'Required parameter "domainId" was null or undefined when calling listDelegations().'
            );
        }
     ...
     * List sending delegations
     */
    async listDelegations(requestParameters: ListDelegationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.listDelegationsRaw(requestParameters, initOverrides);
    }
     ...
     */
    async revokeDelegationRaw(requestParameters: RevokeDelegationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['domainId'] == null) {
            throw new runtime.RequiredError(
                'domainId',
                'Required parameter "domainId" was null or undefined when calling revokeDelegation().'
            );
        }
        ...
        if (requestParameters['delegationId'] == null) {
            throw new runtime.RequiredError(
                'delegationId',
                'Required parameter "delegationId" was null or undefined when calling revokeDelegation().'
            );
        }
        ...
        let urlPath = `/v1/sending-domains/{domain_id}/delegations/{delegation_id}`;
        urlPath = urlPath.replace(`{${"domain_id"}}`, encodeURIComponent(String(requestParameters['domainId'])));
        urlPath = urlPath.replace(`{${"delegation_id"}}`, encodeURIComponent(String(requestParameters['delegationId'])));
     ...
     * Revoke a sending delegation
     */
    async revokeDelegation(requestParameters: RevokeDelegationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.revokeDelegationRaw(requestParameters, initOverrides);
    }
