 ...
 * 
 */
export class GlobalSuppressionsApi extends runtime.BaseAPI {

    /**
     * Add an override to allow sending to a globally suppressed email address.
     * Add global suppression override
     */
    async addGlobalSuppressionOverrideRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        let urlPath = `/v1/global-suppressions/overrides`;
     ...
     * Add global suppression override
     */
    async addGlobalSuppressionOverride(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.addGlobalSuppressionOverrideRaw(initOverrides);
    }
     ...
     */
    async checkGlobalSuppressionRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/global-suppressions/check`;
     ...
     * Check global suppression
     */
    async checkGlobalSuppression(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.checkGlobalSuppressionRaw(initOverrides);
    }
     ...
     */
    async removeGlobalSuppressionOverrideRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Remove global suppression override
     */
    async removeGlobalSuppressionOverride(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.removeGlobalSuppressionOverrideRaw(initOverrides);
    }
