...
export interface GetIspFblGuideRequest {
    ispId: string;
}
 ...
 * 
 */
export class ISPFBLGuidesApi extends runtime.BaseAPI {

    /**
     * Retrieve a specific ISP feedback loop setup guide.
     * Get ISP FBL guide
     */
    async getIspFblGuideRaw(requestParameters: GetIspFblGuideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['ispId'] == null) {
            throw new runtime.RequiredError(
                'ispId',
                'Required parameter "ispId" was null or undefined when calling getIspFblGuide().'
            );
        }
        ...
        let urlPath = `/v1/isp-fbl/guides/{isp_id}`;
        urlPath = urlPath.replace(`{${"isp_id"}}`, encodeURIComponent(String(requestParameters['ispId'])));
     ...
     * Get ISP FBL guide
     */
    async getIspFblGuide(requestParameters: GetIspFblGuideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getIspFblGuideRaw(requestParameters, initOverrides);
    }
     ...
     * List ISP FBL guides
     */
    async listIspFblGuidesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * List ISP FBL guides
     */
    async listIspFblGuides(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.listIspFblGuidesRaw(initOverrides);
    }
