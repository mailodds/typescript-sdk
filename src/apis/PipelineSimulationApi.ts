 ...
 * 
 */
export class PipelineSimulationApi extends runtime.BaseAPI {

    /**
     * Dry-run the sending or receiving pipeline to preview what would happen without side effects.
     * Simulate sending pipeline
     */
    async simulatePipelineRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * Simulate sending pipeline
     */
    async simulatePipeline(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.simulatePipelineRaw(initOverrides);
    }
