...
import {
    McpCapabilitiesFromJSON,
    McpCapabilitiesToJSON,
} from '../models/index';

/**
 * 
 */
export class AgentControlPlaneApi extends runtime.BaseAPI {
     ...
     */
    async getMcpCapabilitiesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<McpCapabilities>> {
        const queryParameters: any = {};

        const headerParameters: runtime.HTTPHeaders = {};


        let urlPath = `/v1/mcp/capabilities`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => McpCapabilitiesFromJSON(jsonValue));
    }
     ...
     * Get MCP capabilities
     */
    async getMcpCapabilities(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<McpCapabilities> {
        const response = await this.getMcpCapabilitiesRaw(initOverrides);
