 ...
 * 
 * @export
 * @interface GetMessageEvents200ResponseEventsInner
 */
export interface GetMessageEvents200ResponseEventsInner {
    /**
     * 
     * @type {string}
     * @memberof GetMessageEvents200ResponseEventsInner
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetMessageEvents200ResponseEventsInner interface.
 */
export function instanceOfGetMessageEvents200ResponseEventsInner(value: object): value is GetMessageEvents200ResponseEventsInner {
    return true;
}

export function GetMessageEvents200ResponseEventsInnerFromJSON(json: any): GetMessageEvents200ResponseEventsInner {
    return GetMessageEvents200ResponseEventsInnerFromJSONTyped(json, false);
}

export function GetMessageEvents200ResponseEventsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetMessageEvents200ResponseEventsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetMessageEvents200ResponseEventsInnerToJSON(json: any): GetMessageEvents200ResponseEventsInner {
    return GetMessageEvents200ResponseEventsInnerToJSONTyped(json, false);
}

export function GetMessageEvents200ResponseEventsInnerToJSONTyped(value?: GetMessageEvents200ResponseEventsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
