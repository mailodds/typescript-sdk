...
import type { GetDmarcTrend200ResponseTrendInner } from './GetDmarcTrend200ResponseTrendInner';
import {
    GetDmarcTrend200ResponseTrendInnerFromJSON,
    GetDmarcTrend200ResponseTrendInnerFromJSONTyped,
    GetDmarcTrend200ResponseTrendInnerToJSON,
    GetDmarcTrend200ResponseTrendInnerToJSONTyped,
} from './GetDmarcTrend200ResponseTrendInner';

/**
 * 
 * @export
 * @interface GetDmarcTrend200Response
 */
export interface GetDmarcTrend200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDmarcTrend200Response
     */
    ...
    /**
     * 
     * @type {Array<GetDmarcTrend200ResponseTrendInner>}
     * @memberof GetDmarcTrend200Response
     */
    trend?: Array<GetDmarcTrend200ResponseTrendInner>;
}

/**
 * Check if a given object implements the GetDmarcTrend200Response interface.
 */
export function instanceOfGetDmarcTrend200Response(value: object): value is GetDmarcTrend200Response {
    return true;
}

export function GetDmarcTrend200ResponseFromJSON(json: any): GetDmarcTrend200Response {
    return GetDmarcTrend200ResponseFromJSONTyped(json, false);
}

export function GetDmarcTrend200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDmarcTrend200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'trend': json['trend'] == null ? undefined : ((json['trend'] as Array<any>).map(GetDmarcTrend200ResponseTrendInnerFromJSON)),
    };
}

export function GetDmarcTrend200ResponseToJSON(json: any): GetDmarcTrend200Response {
    return GetDmarcTrend200ResponseToJSONTyped(json, false);
}

export function GetDmarcTrend200ResponseToJSONTyped(value?: GetDmarcTrend200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'trend': value['trend'] == null ? undefined : ((value['trend'] as Array<any>).map(GetDmarcTrend200ResponseTrendInnerToJSON)),
    };
}
