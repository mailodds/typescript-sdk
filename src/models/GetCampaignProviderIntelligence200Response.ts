...
import type { GetCampaignProviderIntelligence200ResponseProvidersInner } from './GetCampaignProviderIntelligence200ResponseProvidersInner';
import {
    GetCampaignProviderIntelligence200ResponseProvidersInnerFromJSON,
    GetCampaignProviderIntelligence200ResponseProvidersInnerFromJSONTyped,
    GetCampaignProviderIntelligence200ResponseProvidersInnerToJSON,
    GetCampaignProviderIntelligence200ResponseProvidersInnerToJSONTyped,
} from './GetCampaignProviderIntelligence200ResponseProvidersInner';

/**
 * 
 * @export
 * @interface GetCampaignProviderIntelligence200Response
 */
export interface GetCampaignProviderIntelligence200Response {
    /**
     * 
     * @type {string}
     * @memberof GetCampaignProviderIntelligence200Response
     */
    ...
    /**
     * 
     * @type {Array<GetCampaignProviderIntelligence200ResponseProvidersInner>}
     * @memberof GetCampaignProviderIntelligence200Response
     */
    providers?: Array<GetCampaignProviderIntelligence200ResponseProvidersInner>;
}

/**
 * Check if a given object implements the GetCampaignProviderIntelligence200Response interface.
 */
export function instanceOfGetCampaignProviderIntelligence200Response(value: object): value is GetCampaignProviderIntelligence200Response {
    return true;
}

export function GetCampaignProviderIntelligence200ResponseFromJSON(json: any): GetCampaignProviderIntelligence200Response {
    return GetCampaignProviderIntelligence200ResponseFromJSONTyped(json, false);
}

export function GetCampaignProviderIntelligence200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignProviderIntelligence200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'providers': json['providers'] == null ? undefined : ((json['providers'] as Array<any>).map(GetCampaignProviderIntelligence200ResponseProvidersInnerFromJSON)),
    };
}

export function GetCampaignProviderIntelligence200ResponseToJSON(json: any): GetCampaignProviderIntelligence200Response {
    return GetCampaignProviderIntelligence200ResponseToJSONTyped(json, false);
}

export function GetCampaignProviderIntelligence200ResponseToJSONTyped(value?: GetCampaignProviderIntelligence200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'providers': value['providers'] == null ? undefined : ((value['providers'] as Array<any>).map(GetCampaignProviderIntelligence200ResponseProvidersInnerToJSON)),
    };
}
