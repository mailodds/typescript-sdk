 ...
 * 
 * @export
 * @interface GetInboundMessage200Response
 */
export interface GetInboundMessage200Response {
    /**
     * 
     * @type {string}
     * @memberof GetInboundMessage200Response
     */
...
/**
 * Check if a given object implements the GetInboundMessage200Response interface.
 */
export function instanceOfGetInboundMessage200Response(value: object): value is GetInboundMessage200Response {
    return true;
}

export function GetInboundMessage200ResponseFromJSON(json: any): GetInboundMessage200Response {
    return GetInboundMessage200ResponseFromJSONTyped(json, false);
}

export function GetInboundMessage200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetInboundMessage200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetInboundMessage200ResponseToJSON(json: any): GetInboundMessage200Response {
    return GetInboundMessage200ResponseToJSONTyped(json, false);
}

export function GetInboundMessage200ResponseToJSONTyped(value?: GetInboundMessage200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
