 ...
 * 
 * @export
 * @interface RunServerTestRequest
 */
export interface RunServerTestRequest {
    /**
     * Domain to test
     * @type {string}
     * @memberof RunServerTestRequest
     */
    domain: string;
}

/**
 * Check if a given object implements the RunServerTestRequest interface.
 */
export function instanceOfRunServerTestRequest(value: object): value is RunServerTestRequest {
    if (!('domain' in value) || value['domain'] === undefined) return false;
    return true;
}

export function RunServerTestRequestFromJSON(json: any): RunServerTestRequest {
    return RunServerTestRequestFromJSONTyped(json, false);
}

export function RunServerTestRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunServerTestRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RunServerTestRequestToJSON(json: any): RunServerTestRequest {
    return RunServerTestRequestToJSONTyped(json, false);
}

export function RunServerTestRequestToJSONTyped(value?: RunServerTestRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
