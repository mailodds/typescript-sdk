 ...
 * @export
 * @interface SpamCheckChecks
 */
export interface SpamCheckChecks {
    /**
     * 
     * @type {object}
     * @memberof SpamCheckChecks
     */
...
/**
 * Check if a given object implements the SpamCheckChecks interface.
 */
export function instanceOfSpamCheckChecks(value: object): value is SpamCheckChecks {
    return true;
}

export function SpamCheckChecksFromJSON(json: any): SpamCheckChecks {
    return SpamCheckChecksFromJSONTyped(json, false);
}

export function SpamCheckChecksFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpamCheckChecks {
    if (json == null) {
        return json;
    }
    return {
        
        'domainReputation': json['domain_reputation'] == null ? undefined : json['domain_reputation'],
        'linkSafety': json['link_safety'] == null ? undefined : json['link_safety'],
        'subjectAnalysis': json['subject_analysis'] == null ? undefined : json['subject_analysis'],
    };
}

export function SpamCheckChecksToJSON(json: any): SpamCheckChecks {
    return SpamCheckChecksToJSONTyped(json, false);
}

export function SpamCheckChecksToJSONTyped(value?: SpamCheckChecks | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'domain_reputation': value['domainReputation'],
        'link_safety': value['linkSafety'],
        'subject_analysis': value['subjectAnalysis'],
    };
}
