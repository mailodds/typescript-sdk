 ...
 * 
 * @export
 * @interface ServerTestMxRecordsInner
 */
export interface ServerTestMxRecordsInner {
    /**
     * 
     * @type {string}
     * @memberof ServerTestMxRecordsInner
     */
    host?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ServerTestMxRecordsInner interface.
 */
export function instanceOfServerTestMxRecordsInner(value: object): value is ServerTestMxRecordsInner {
    return true;
}

export function ServerTestMxRecordsInnerFromJSON(json: any): ServerTestMxRecordsInner {
    return ServerTestMxRecordsInnerFromJSONTyped(json, false);
}

export function ServerTestMxRecordsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerTestMxRecordsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ServerTestMxRecordsInnerToJSON(json: any): ServerTestMxRecordsInner {
    return ServerTestMxRecordsInnerToJSONTyped(json, false);
}

export function ServerTestMxRecordsInnerToJSONTyped(value?: ServerTestMxRecordsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
