 ...
 * 
 * @export
 * @interface BatchCheckOooRequest
 */
export interface BatchCheckOooRequest {
    /**
     * Email addresses to check
     * @type {Array<string>}
     * @memberof BatchCheckOooRequest
     */
    emails: Array<string>;
}

/**
 * Check if a given object implements the BatchCheckOooRequest interface.
 */
export function instanceOfBatchCheckOooRequest(value: object): value is BatchCheckOooRequest {
    if (!('emails' in value) || value['emails'] === undefined) return false;
    return true;
}

export function BatchCheckOooRequestFromJSON(json: any): BatchCheckOooRequest {
    return BatchCheckOooRequestFromJSONTyped(json, false);
}

export function BatchCheckOooRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchCheckOooRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function BatchCheckOooRequestToJSON(json: any): BatchCheckOooRequest {
    return BatchCheckOooRequestToJSONTyped(json, false);
}

export function BatchCheckOooRequestToJSONTyped(value?: BatchCheckOooRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
