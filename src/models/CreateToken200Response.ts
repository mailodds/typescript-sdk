...
export function CreateToken200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateToken200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateToken200ResponseToJSONTyped(value?: CreateToken200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
