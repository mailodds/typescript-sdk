 ...
 * 
 * @export
 * @interface AddBlacklistMonitorRequest
 */
export interface AddBlacklistMonitorRequest {
    /**
     * IP address or domain to monitor
     * @type {string}
     * @memberof AddBlacklistMonitorRequest
     */
    target: string;
    /**
     ...
     * @memberof AddBlacklistMonitorRequest
     */
    targetType: AddBlacklistMonitorRequestTargetTypeEnum;
}
 ...
 * @export
 */
export const AddBlacklistMonitorRequestTargetTypeEnum = {
    Ip: 'ip',
    Domain: 'domain'
} as const;
export type AddBlacklistMonitorRequestTargetTypeEnum = typeof AddBlacklistMonitorRequestTargetTypeEnum[keyof typeof AddBlacklistMonitorRequestTargetTypeEnum];


/**
 * Check if a given object implements the AddBlacklistMonitorRequest interface.
 */
export function instanceOfAddBlacklistMonitorRequest(value: object): value is AddBlacklistMonitorRequest {
    if (!('target' in value) || value['target'] === undefined) return false;
    if (!('targetType' in value) || value['targetType'] === undefined) return false;
    return true;
}

export function AddBlacklistMonitorRequestFromJSON(json: any): AddBlacklistMonitorRequest {
    return AddBlacklistMonitorRequestFromJSONTyped(json, false);
}

export function AddBlacklistMonitorRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddBlacklistMonitorRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AddBlacklistMonitorRequestToJSON(json: any): AddBlacklistMonitorRequest {
    return AddBlacklistMonitorRequestToJSONTyped(json, false);
}

export function AddBlacklistMonitorRequestToJSONTyped(value?: AddBlacklistMonitorRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
