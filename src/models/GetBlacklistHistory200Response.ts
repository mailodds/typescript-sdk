...
import type { GetBlacklistHistory200ResponseChecksInner } from './GetBlacklistHistory200ResponseChecksInner';
import {
    GetBlacklistHistory200ResponseChecksInnerFromJSON,
    GetBlacklistHistory200ResponseChecksInnerFromJSONTyped,
    GetBlacklistHistory200ResponseChecksInnerToJSON,
    GetBlacklistHistory200ResponseChecksInnerToJSONTyped,
} from './GetBlacklistHistory200ResponseChecksInner';

/**
 * 
 * @export
 * @interface GetBlacklistHistory200Response
 */
export interface GetBlacklistHistory200Response {
    /**
     * 
     * @type {string}
     * @memberof GetBlacklistHistory200Response
     */
    ...
    /**
     * 
     * @type {Array<GetBlacklistHistory200ResponseChecksInner>}
     * @memberof GetBlacklistHistory200Response
     */
    checks?: Array<GetBlacklistHistory200ResponseChecksInner>;
    /**
     * 
     * @type {Pagination}
     * @memberof GetBlacklistHistory200Response
...
/**
 * Check if a given object implements the GetBlacklistHistory200Response interface.
 */
export function instanceOfGetBlacklistHistory200Response(value: object): value is GetBlacklistHistory200Response {
    return true;
}

export function GetBlacklistHistory200ResponseFromJSON(json: any): GetBlacklistHistory200Response {
    return GetBlacklistHistory200ResponseFromJSONTyped(json, false);
}

export function GetBlacklistHistory200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetBlacklistHistory200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'checks': json['checks'] == null ? undefined : ((json['checks'] as Array<any>).map(GetBlacklistHistory200ResponseChecksInnerFromJSON)),
        'pagination': json['pagination'] == null ? undefined : PaginationFromJSON(json['pagination']),
    };
}

export function GetBlacklistHistory200ResponseToJSON(json: any): GetBlacklistHistory200Response {
    return GetBlacklistHistory200ResponseToJSONTyped(json, false);
}

export function GetBlacklistHistory200ResponseToJSONTyped(value?: GetBlacklistHistory200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'checks': value['checks'] == null ? undefined : ((value['checks'] as Array<any>).map(GetBlacklistHistory200ResponseChecksInnerToJSON)),
