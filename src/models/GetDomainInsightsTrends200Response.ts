 ...
 * 
 * @export
 * @interface GetDomainInsightsTrends200Response
 */
export interface GetDomainInsightsTrends200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDomainInsightsTrends200Response
     */
...
/**
 * Check if a given object implements the GetDomainInsightsTrends200Response interface.
 */
export function instanceOfGetDomainInsightsTrends200Response(value: object): value is GetDomainInsightsTrends200Response {
    return true;
}

export function GetDomainInsightsTrends200ResponseFromJSON(json: any): GetDomainInsightsTrends200Response {
    return GetDomainInsightsTrends200ResponseFromJSONTyped(json, false);
}

export function GetDomainInsightsTrends200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDomainInsightsTrends200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetDomainInsightsTrends200ResponseToJSON(json: any): GetDomainInsightsTrends200Response {
    return GetDomainInsightsTrends200ResponseToJSONTyped(json, false);
}

export function GetDomainInsightsTrends200ResponseToJSONTyped(value?: GetDomainInsightsTrends200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
