 ...
 * 
 * @export
 * @interface ListServerTests200Response
 */
export interface ListServerTests200Response {
    /**
     * 
     * @type {string}
...
/**
 * Check if a given object implements the ListServerTests200Response interface.
 */
export function instanceOfListServerTests200Response(value: object): value is ListServerTests200Response {
    return true;
}

export function ListServerTests200ResponseFromJSON(json: any): ListServerTests200Response {
    return ListServerTests200ResponseFromJSONTyped(json, false);
}

export function ListServerTests200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListServerTests200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListServerTests200ResponseToJSON(json: any): ListServerTests200Response {
    return ListServerTests200ResponseToJSONTyped(json, false);
}

export function ListServerTests200ResponseToJSONTyped(value?: ListServerTests200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
