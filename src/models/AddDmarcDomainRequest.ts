 ...
 * 
 * @export
 * @interface AddDmarcDomainRequest
 */
export interface AddDmarcDomainRequest {
    /**
     * Domain name to monitor
     * @type {string}
     * @memberof AddDmarcDomainRequest
     */
    domain: string;
}

/**
 * Check if a given object implements the AddDmarcDomainRequest interface.
 */
export function instanceOfAddDmarcDomainRequest(value: object): value is AddDmarcDomainRequest {
    if (!('domain' in value) || value['domain'] === undefined) return false;
    return true;
}

export function AddDmarcDomainRequestFromJSON(json: any): AddDmarcDomainRequest {
    return AddDmarcDomainRequestFromJSONTyped(json, false);
}

export function AddDmarcDomainRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddDmarcDomainRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AddDmarcDomainRequestToJSON(json: any): AddDmarcDomainRequest {
    return AddDmarcDomainRequestToJSONTyped(json, false);
}

export function AddDmarcDomainRequestToJSONTyped(value?: AddDmarcDomainRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
