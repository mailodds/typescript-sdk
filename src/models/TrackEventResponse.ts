...
/**
 * Check if a given object implements the TrackEventResponse interface.
 */
export function instanceOfTrackEventResponse(value: object): value is TrackEventResponse {
    return true;
}

export function TrackEventResponseFromJSON(json: any): TrackEventResponse {
    return TrackEventResponseFromJSONTyped(json, false);
}

export function TrackEventResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackEventResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function TrackEventResponseToJSON(json: any): TrackEventResponse {
    return TrackEventResponseToJSONTyped(json, false);
}

export function TrackEventResponseToJSONTyped(value?: TrackEventResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
