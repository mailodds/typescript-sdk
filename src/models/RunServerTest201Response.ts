...
import type { ServerTest } from './ServerTest';
import {
    ServerTestFromJSON,
    ServerTestFromJSONTyped,
    ServerTestToJSON,
    ServerTestToJSONTyped,
} from './ServerTest';

/**
 * 
 * @export
 * @interface RunServerTest201Response
 */
export interface RunServerTest201Response {
    /**
     * 
     * @type {string}
     * @memberof RunServerTest201Response
     */
...
/**
 * Check if a given object implements the RunServerTest201Response interface.
 */
export function instanceOfRunServerTest201Response(value: object): value is RunServerTest201Response {
    return true;
}

export function RunServerTest201ResponseFromJSON(json: any): RunServerTest201Response {
    return RunServerTest201ResponseFromJSONTyped(json, false);
}

export function RunServerTest201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunServerTest201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'test': json['test'] == null ? undefined : ServerTestFromJSON(json['test']),
    };
}

export function RunServerTest201ResponseToJSON(json: any): RunServerTest201Response {
    return RunServerTest201ResponseToJSONTyped(json, false);
}

export function RunServerTest201ResponseToJSONTyped(value?: RunServerTest201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'test': ServerTestToJSON(value['test']),
    };
}
