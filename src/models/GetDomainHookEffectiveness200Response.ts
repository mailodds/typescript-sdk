 ...
 * 
 * @export
 * @interface GetDomainHookEffectiveness200Response
 */
export interface GetDomainHookEffectiveness200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDomainHookEffectiveness200Response
     */
...
/**
 * Check if a given object implements the GetDomainHookEffectiveness200Response interface.
 */
export function instanceOfGetDomainHookEffectiveness200Response(value: object): value is GetDomainHookEffectiveness200Response {
    return true;
}

export function GetDomainHookEffectiveness200ResponseFromJSON(json: any): GetDomainHookEffectiveness200Response {
    return GetDomainHookEffectiveness200ResponseFromJSONTyped(json, false);
}

export function GetDomainHookEffectiveness200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDomainHookEffectiveness200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'effectiveness': json['effectiveness'] == null ? undefined : json['effectiveness'],
    };
}

export function GetDomainHookEffectiveness200ResponseToJSON(json: any): GetDomainHookEffectiveness200Response {
    return GetDomainHookEffectiveness200ResponseToJSONTyped(json, false);
}

export function GetDomainHookEffectiveness200ResponseToJSONTyped(value?: GetDomainHookEffectiveness200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
