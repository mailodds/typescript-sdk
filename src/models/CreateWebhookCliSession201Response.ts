 ...
 * 
 * @export
 * @interface CreateWebhookCliSession201Response
 */
export interface CreateWebhookCliSession201Response {
    /**
     * 
     * @type {string}
     * @memberof CreateWebhookCliSession201Response
     */
    sessionId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the CreateWebhookCliSession201Response interface.
 */
export function instanceOfCreateWebhookCliSession201Response(value: object): value is CreateWebhookCliSession201Response {
    return true;
}

export function CreateWebhookCliSession201ResponseFromJSON(json: any): CreateWebhookCliSession201Response {
    return CreateWebhookCliSession201ResponseFromJSONTyped(json, false);
}

export function CreateWebhookCliSession201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWebhookCliSession201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sseUrl': json['sse_url'] == null ? undefined : json['sse_url'],
    };
}

export function CreateWebhookCliSession201ResponseToJSON(json: any): CreateWebhookCliSession201Response {
    return CreateWebhookCliSession201ResponseToJSONTyped(json, false);
}

export function CreateWebhookCliSession201ResponseToJSONTyped(value?: CreateWebhookCliSession201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
