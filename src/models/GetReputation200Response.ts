 ...
 * 
 * @export
 * @interface GetReputation200Response
 */
export interface GetReputation200Response {
    /**
     * 
     * @type {string}
     * @memberof GetReputation200Response
     */
...
/**
 * Check if a given object implements the GetReputation200Response interface.
 */
export function instanceOfGetReputation200Response(value: object): value is GetReputation200Response {
    return true;
}

export function GetReputation200ResponseFromJSON(json: any): GetReputation200Response {
    return GetReputation200ResponseFromJSONTyped(json, false);
}

export function GetReputation200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReputation200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetReputation200ResponseToJSON(json: any): GetReputation200Response {
    return GetReputation200ResponseToJSONTyped(json, false);
}

export function GetReputation200ResponseToJSONTyped(value?: GetReputation200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
