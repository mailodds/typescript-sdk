...
/**
 * Check if a given object implements the ListCampaigns200Response interface.
 */
export function instanceOfListCampaigns200Response(value: object): value is ListCampaigns200Response {
    return true;
}

export function ListCampaigns200ResponseFromJSON(json: any): ListCampaigns200Response {
    return ListCampaigns200ResponseFromJSONTyped(json, false);
}

export function ListCampaigns200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListCampaigns200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListCampaigns200ResponseToJSON(json: any): ListCampaigns200Response {
    return ListCampaigns200ResponseToJSONTyped(json, false);
}

export function ListCampaigns200ResponseToJSONTyped(value?: ListCampaigns200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
