 ...
 * 
 * @export
 * @interface RunBlacklistCheck200ResponseCheck
 */
export interface RunBlacklistCheck200ResponseCheck {
    /**
     * 
     * @type {string}
     * @memberof RunBlacklistCheck200ResponseCheck
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the RunBlacklistCheck200ResponseCheck interface.
 */
export function instanceOfRunBlacklistCheck200ResponseCheck(value: object): value is RunBlacklistCheck200ResponseCheck {
    return true;
}

export function RunBlacklistCheck200ResponseCheckFromJSON(json: any): RunBlacklistCheck200ResponseCheck {
    return RunBlacklistCheck200ResponseCheckFromJSONTyped(json, false);
}

export function RunBlacklistCheck200ResponseCheckFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunBlacklistCheck200ResponseCheck {
    if (json == null) {
        return json;
    }
    return {
...
export function RunBlacklistCheck200ResponseCheckToJSON(json: any): RunBlacklistCheck200ResponseCheck {
    return RunBlacklistCheck200ResponseCheckToJSONTyped(json, false);
}

export function RunBlacklistCheck200ResponseCheckToJSONTyped(value?: RunBlacklistCheck200ResponseCheck | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
