 ...
 * 
 * @export
 * @interface ListOooContacts200Response
 */
export interface ListOooContacts200Response {
    /**
     * 
     * @type {string}
     * @memberof ListOooContacts200Response
     */
...
/**
 * Check if a given object implements the ListOooContacts200Response interface.
 */
export function instanceOfListOooContacts200Response(value: object): value is ListOooContacts200Response {
    return true;
}

export function ListOooContacts200ResponseFromJSON(json: any): ListOooContacts200Response {
    return ListOooContacts200ResponseFromJSONTyped(json, false);
}

export function ListOooContacts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListOooContacts200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListOooContacts200ResponseToJSON(json: any): ListOooContacts200Response {
    return ListOooContacts200ResponseToJSONTyped(json, false);
}

export function ListOooContacts200ResponseToJSONTyped(value?: ListOooContacts200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
