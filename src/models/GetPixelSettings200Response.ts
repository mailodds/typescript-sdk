 ...
 * 
 * @export
 * @interface GetPixelSettings200Response
 */
export interface GetPixelSettings200Response {
    /**
     * 
     * @type {string}
     * @memberof GetPixelSettings200Response
     */
    pixelUuid?: string | null;
    /**
     * 
     * @type {number}
     * @memberof GetPixelSettings200Response
     */
    pixelSubscribeListId?: number | null;
}

/**
 * Check if a given object implements the GetPixelSettings200Response interface.
 */
export function instanceOfGetPixelSettings200Response(value: object): value is GetPixelSettings200Response {
    return true;
}

export function GetPixelSettings200ResponseFromJSON(json: any): GetPixelSettings200Response {
    return GetPixelSettings200ResponseFromJSONTyped(json, false);
}

export function GetPixelSettings200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetPixelSettings200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'pixelUuid': json['pixel_uuid'] == null ? undefined : json['pixel_uuid'],
        'pixelSubscribeListId': json['pixel_subscribe_list_id'] == null ? undefined : json['pixel_subscribe_list_id'],
    };
}

export function GetPixelSettings200ResponseToJSON(json: any): GetPixelSettings200Response {
    return GetPixelSettings200ResponseToJSONTyped(json, false);
}

export function GetPixelSettings200ResponseToJSONTyped(value?: GetPixelSettings200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'pixel_uuid': value['pixelUuid'],
        'pixel_subscribe_list_id': value['pixelSubscribeListId'],
    };
}
