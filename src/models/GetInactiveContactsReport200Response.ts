...
import type { GetInactiveContactsReport200ResponseByListInner } from './GetInactiveContactsReport200ResponseByListInner';
import {
    GetInactiveContactsReport200ResponseByListInnerFromJSON,
    GetInactiveContactsReport200ResponseByListInnerFromJSONTyped,
    GetInactiveContactsReport200ResponseByListInnerToJSON,
    GetInactiveContactsReport200ResponseByListInnerToJSONTyped,
} from './GetInactiveContactsReport200ResponseByListInner';

/**
 * 
 * @export
 * @interface GetInactiveContactsReport200Response
 */
export interface GetInactiveContactsReport200Response {
    /**
     * 
     * @type {string}
     * @memberof GetInactiveContactsReport200Response
     */
    ...
    /**
     * 
     * @type {Array<GetInactiveContactsReport200ResponseByListInner>}
     * @memberof GetInactiveContactsReport200Response
     */
    byList?: Array<GetInactiveContactsReport200ResponseByListInner>;
}

/**
 * Check if a given object implements the GetInactiveContactsReport200Response interface.
 */
export function instanceOfGetInactiveContactsReport200Response(value: object): value is GetInactiveContactsReport200Response {
    return true;
}

export function GetInactiveContactsReport200ResponseFromJSON(json: any): GetInactiveContactsReport200Response {
    return GetInactiveContactsReport200ResponseFromJSONTyped(json, false);
}

export function GetInactiveContactsReport200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetInactiveContactsReport200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'inactiveCount': json['inactive_count'] == null ? undefined : json['inactive_count'],
        'totalContacts': json['total_contacts'] == null ? undefined : json['total_contacts'],
        'inactiveRate': json['inactive_rate'] == null ? undefined : json['inactive_rate'],
        'byList': json['by_list'] == null ? undefined : ((json['by_list'] as Array<any>).map(GetInactiveContactsReport200ResponseByListInnerFromJSON)),
    };
}

export function GetInactiveContactsReport200ResponseToJSON(json: any): GetInactiveContactsReport200Response {
    return GetInactiveContactsReport200ResponseToJSONTyped(json, false);
}

export function GetInactiveContactsReport200ResponseToJSONTyped(value?: GetInactiveContactsReport200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'inactive_count': value['inactiveCount'],
        'total_contacts': value['totalContacts'],
        'inactive_rate': value['inactiveRate'],
        'by_list': value['byList'] == null ? undefined : ((value['byList'] as Array<any>).map(GetInactiveContactsReport200ResponseByListInnerToJSON)),
    };
}
