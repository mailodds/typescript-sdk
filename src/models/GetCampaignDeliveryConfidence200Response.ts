...
import type { GetCampaignDeliveryConfidence200ResponseFactors } from './GetCampaignDeliveryConfidence200ResponseFactors';
import {
    GetCampaignDeliveryConfidence200ResponseFactorsFromJSON,
    GetCampaignDeliveryConfidence200ResponseFactorsFromJSONTyped,
    GetCampaignDeliveryConfidence200ResponseFactorsToJSON,
    GetCampaignDeliveryConfidence200ResponseFactorsToJSONTyped,
} from './GetCampaignDeliveryConfidence200ResponseFactors';

/**
 * 
 * @export
 * @interface GetCampaignDeliveryConfidence200Response
 */
export interface GetCampaignDeliveryConfidence200Response {
    /**
     * 
     * @type {string}
     * @memberof GetCampaignDeliveryConfidence200Response
     */
    ...
    /**
     * 
     * @type {GetCampaignDeliveryConfidence200ResponseFactors}
     * @memberof GetCampaignDeliveryConfidence200Response
     */
    factors?: GetCampaignDeliveryConfidence200ResponseFactors;
    /**
...
/**
 * Check if a given object implements the GetCampaignDeliveryConfidence200Response interface.
 */
export function instanceOfGetCampaignDeliveryConfidence200Response(value: object): value is GetCampaignDeliveryConfidence200Response {
    return true;
}

export function GetCampaignDeliveryConfidence200ResponseFromJSON(json: any): GetCampaignDeliveryConfidence200Response {
    return GetCampaignDeliveryConfidence200ResponseFromJSONTyped(json, false);
}

export function GetCampaignDeliveryConfidence200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignDeliveryConfidence200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'factors': json['factors'] == null ? undefined : GetCampaignDeliveryConfidence200ResponseFactorsFromJSON(json['factors']),
        'recommendations': json['recommendations'] == null ? undefined : json['recommendations'],
    };
}

export function GetCampaignDeliveryConfidence200ResponseToJSON(json: any): GetCampaignDeliveryConfidence200Response {
    return GetCampaignDeliveryConfidence200ResponseToJSONTyped(json, false);
}

export function GetCampaignDeliveryConfidence200ResponseToJSONTyped(value?: GetCampaignDeliveryConfidence200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'factors': GetCampaignDeliveryConfidence200ResponseFactorsToJSON(value['factors']),
