...
import type { BounceAnalysisResponseAnalysis } from './BounceAnalysisResponseAnalysis';
import {
    BounceAnalysisResponseAnalysisFromJSON,
    BounceAnalysisResponseAnalysisFromJSONTyped,
    BounceAnalysisResponseAnalysisToJSON,
    BounceAnalysisResponseAnalysisToJSONTyped,
} from './BounceAnalysisResponseAnalysis';
 ...
 */
export interface BounceAnalysisResponse {
    /**
     * 
     * @type {string}
     * @memberof BounceAnalysisResponse
     */
    ...
    /**
     * 
     * @type {BounceAnalysisResponseAnalysis}
     * @memberof BounceAnalysisResponse
     */
    analysis?: BounceAnalysisResponseAnalysis;
}

/**
 * Check if a given object implements the BounceAnalysisResponse interface.
 */
export function instanceOfBounceAnalysisResponse(value: object): value is BounceAnalysisResponse {
    return true;
}

export function BounceAnalysisResponseFromJSON(json: any): BounceAnalysisResponse {
    return BounceAnalysisResponseFromJSONTyped(json, false);
}

export function BounceAnalysisResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BounceAnalysisResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'analysis': json['analysis'] == null ? undefined : BounceAnalysisResponseAnalysisFromJSON(json['analysis']),
    };
}

export function BounceAnalysisResponseToJSON(json: any): BounceAnalysisResponse {
    return BounceAnalysisResponseToJSONTyped(json, false);
}

export function BounceAnalysisResponseToJSONTyped(value?: BounceAnalysisResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'analysis': BounceAnalysisResponseAnalysisToJSON(value['analysis']),
    };
}
