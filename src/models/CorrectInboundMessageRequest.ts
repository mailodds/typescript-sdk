 ...
 * 
 * @export
 * @interface CorrectInboundMessageRequest
 */
export interface CorrectInboundMessageRequest {
    /**
     * Corrected classification label
     * @type {string}
     * @memberof CorrectInboundMessageRequest
     */
    correction: string;
}

/**
 * Check if a given object implements the CorrectInboundMessageRequest interface.
 */
export function instanceOfCorrectInboundMessageRequest(value: object): value is CorrectInboundMessageRequest {
    if (!('correction' in value) || value['correction'] === undefined) return false;
    return true;
}

export function CorrectInboundMessageRequestFromJSON(json: any): CorrectInboundMessageRequest {
    return CorrectInboundMessageRequestFromJSONTyped(json, false);
}

export function CorrectInboundMessageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorrectInboundMessageRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CorrectInboundMessageRequestToJSON(json: any): CorrectInboundMessageRequest {
    return CorrectInboundMessageRequestToJSONTyped(json, false);
}

export function CorrectInboundMessageRequestToJSONTyped(value?: CorrectInboundMessageRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
