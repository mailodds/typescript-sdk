 ...
 * 
 * @export
 * @interface BulkUpdateProducts200Response
 */
export interface BulkUpdateProducts200Response {
    /**
     * 
     * @type {string}
     * @memberof BulkUpdateProducts200Response
     */
...
/**
 * Check if a given object implements the BulkUpdateProducts200Response interface.
 */
export function instanceOfBulkUpdateProducts200Response(value: object): value is BulkUpdateProducts200Response {
    return true;
}

export function BulkUpdateProducts200ResponseFromJSON(json: any): BulkUpdateProducts200Response {
    return BulkUpdateProducts200ResponseFromJSONTyped(json, false);
}

export function BulkUpdateProducts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkUpdateProducts200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function BulkUpdateProducts200ResponseToJSON(json: any): BulkUpdateProducts200Response {
    return BulkUpdateProducts200ResponseToJSONTyped(json, false);
}

export function BulkUpdateProducts200ResponseToJSONTyped(value?: BulkUpdateProducts200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
