 ...
 * 
 * @export
 * @interface ConnectDnsProviderRequest
 */
export interface ConnectDnsProviderRequest {
    /**
     * DNS provider
     * @type {string}
     * @memberof ConnectDnsProviderRequest
     */
    provider: ConnectDnsProviderRequestProviderEnum;
    /**
 ...
 * @export
 */
export const ConnectDnsProviderRequestProviderEnum = {
    Cloudflare: 'cloudflare'
} as const;
export type ConnectDnsProviderRequestProviderEnum = typeof ConnectDnsProviderRequestProviderEnum[keyof typeof ConnectDnsProviderRequestProviderEnum];


/**
 * Check if a given object implements the ConnectDnsProviderRequest interface.
 */
export function instanceOfConnectDnsProviderRequest(value: object): value is ConnectDnsProviderRequest {
    if (!('provider' in value) || value['provider'] === undefined) return false;
    if (!('apiToken' in value) || value['apiToken'] === undefined) return false;
    return true;
}

export function ConnectDnsProviderRequestFromJSON(json: any): ConnectDnsProviderRequest {
    return ConnectDnsProviderRequestFromJSONTyped(json, false);
}

export function ConnectDnsProviderRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConnectDnsProviderRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ConnectDnsProviderRequestToJSON(json: any): ConnectDnsProviderRequest {
    return ConnectDnsProviderRequestToJSONTyped(json, false);
}

export function ConnectDnsProviderRequestToJSONTyped(value?: ConnectDnsProviderRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
