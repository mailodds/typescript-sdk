 ...
 * 
 * @export
 * @interface ServerTestDnsChecks
 */
export interface ServerTestDnsChecks {
    /**
     * 
     * @type {boolean}
     * @memberof ServerTestDnsChecks
     */
    spf?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ServerTestDnsChecks interface.
 */
export function instanceOfServerTestDnsChecks(value: object): value is ServerTestDnsChecks {
    return true;
}

export function ServerTestDnsChecksFromJSON(json: any): ServerTestDnsChecks {
    return ServerTestDnsChecksFromJSONTyped(json, false);
}

export function ServerTestDnsChecksFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerTestDnsChecks {
    if (json == null) {
        return json;
    }
    return {
...
export function ServerTestDnsChecksToJSON(json: any): ServerTestDnsChecks {
    return ServerTestDnsChecksToJSONTyped(json, false);
}

export function ServerTestDnsChecksToJSONTyped(value?: ServerTestDnsChecks | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
