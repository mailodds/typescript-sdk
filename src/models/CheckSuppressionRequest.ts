 ...
 * 
 * @export
 * @interface CheckSuppressionRequest
 */
export interface CheckSuppressionRequest {
    /**
     * 
     * @type {string}
     * @memberof CheckSuppressionRequest
     */
    email: string;
}

/**
 * Check if a given object implements the CheckSuppressionRequest interface.
 */
export function instanceOfCheckSuppressionRequest(value: object): value is CheckSuppressionRequest {
    if (!('email' in value) || value['email'] === undefined) return false;
    return true;
}

export function CheckSuppressionRequestFromJSON(json: any): CheckSuppressionRequest {
    return CheckSuppressionRequestFromJSONTyped(json, false);
}

export function CheckSuppressionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckSuppressionRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CheckSuppressionRequestToJSON(json: any): CheckSuppressionRequest {
    return CheckSuppressionRequestToJSONTyped(json, false);
}

export function CheckSuppressionRequestToJSONTyped(value?: CheckSuppressionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
