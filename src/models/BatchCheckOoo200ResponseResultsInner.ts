 ...
 * 
 * @export
 * @interface BatchCheckOoo200ResponseResultsInner
 */
export interface BatchCheckOoo200ResponseResultsInner {
    /**
     * 
     * @type {string}
     * @memberof BatchCheckOoo200ResponseResultsInner
     */
    email?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BatchCheckOoo200ResponseResultsInner interface.
 */
export function instanceOfBatchCheckOoo200ResponseResultsInner(value: object): value is BatchCheckOoo200ResponseResultsInner {
    return true;
}

export function BatchCheckOoo200ResponseResultsInnerFromJSON(json: any): BatchCheckOoo200ResponseResultsInner {
    return BatchCheckOoo200ResponseResultsInnerFromJSONTyped(json, false);
}

export function BatchCheckOoo200ResponseResultsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchCheckOoo200ResponseResultsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'isOoo': json['is_ooo'] == null ? undefined : json['is_ooo'],
        'detectedAt': json['detected_at'] == null ? undefined : (new Date(json['detected_at'])),
        'expiresAt': json['expires_at'] == null ? undefined : (new Date(json['expires_at'])),
    };
}

export function BatchCheckOoo200ResponseResultsInnerToJSON(json: any): BatchCheckOoo200ResponseResultsInner {
    return BatchCheckOoo200ResponseResultsInnerToJSONTyped(json, false);
}

export function BatchCheckOoo200ResponseResultsInnerToJSONTyped(value?: BatchCheckOoo200ResponseResultsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'email': value['email'],
        'is_ooo': value['isOoo'],
        'detected_at': value['detectedAt'] == null ? value['detectedAt'] : value['detectedAt'].toISOString(),
