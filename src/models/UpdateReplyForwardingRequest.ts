 ...
 * 
 * @export
 * @interface UpdateReplyForwardingRequest
 */
export interface UpdateReplyForwardingRequest {
    /**
     * Email to forward replies to, or null to disable
     * @type {string}
     * @memberof UpdateReplyForwardingRequest
     */
    forwardRepliesTo?: string | null;
}

/**
 * Check if a given object implements the UpdateReplyForwardingRequest interface.
 */
export function instanceOfUpdateReplyForwardingRequest(value: object): value is UpdateReplyForwardingRequest {
    return true;
}

export function UpdateReplyForwardingRequestFromJSON(json: any): UpdateReplyForwardingRequest {
    return UpdateReplyForwardingRequestFromJSONTyped(json, false);
}

export function UpdateReplyForwardingRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateReplyForwardingRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateReplyForwardingRequestToJSON(json: any): UpdateReplyForwardingRequest {
    return UpdateReplyForwardingRequestToJSONTyped(json, false);
}

export function UpdateReplyForwardingRequestToJSONTyped(value?: UpdateReplyForwardingRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
