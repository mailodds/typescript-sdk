 ...
 * 
 * @export
 * @interface GetCampaignAttribution200ResponseAttributionFirstTouch
 */
export interface GetCampaignAttribution200ResponseAttributionFirstTouch {
    /**
     * 
     * @type {number}
     * @memberof GetCampaignAttribution200ResponseAttributionFirstTouch
     */
    conversions?: number;
    /**
     * 
...
/**
 * Check if a given object implements the GetCampaignAttribution200ResponseAttributionFirstTouch interface.
 */
export function instanceOfGetCampaignAttribution200ResponseAttributionFirstTouch(value: object): value is GetCampaignAttribution200ResponseAttributionFirstTouch {
    return true;
}

export function GetCampaignAttribution200ResponseAttributionFirstTouchFromJSON(json: any): GetCampaignAttribution200ResponseAttributionFirstTouch {
    return GetCampaignAttribution200ResponseAttributionFirstTouchFromJSONTyped(json, false);
}

export function GetCampaignAttribution200ResponseAttributionFirstTouchFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignAttribution200ResponseAttributionFirstTouch {
    if (json == null) {
        return json;
    }
    return {
...
export function GetCampaignAttribution200ResponseAttributionFirstTouchToJSON(json: any): GetCampaignAttribution200ResponseAttributionFirstTouch {
    return GetCampaignAttribution200ResponseAttributionFirstTouchToJSONTyped(json, false);
}

export function GetCampaignAttribution200ResponseAttributionFirstTouchToJSONTyped(value?: GetCampaignAttribution200ResponseAttributionFirstTouch | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
