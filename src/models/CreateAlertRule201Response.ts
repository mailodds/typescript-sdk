 ...
 * 
 * @export
 * @interface CreateAlertRule201Response
 */
export interface CreateAlertRule201Response {
    /**
     * 
     * @type {string}
     * @memberof CreateAlertRule201Response
     */
...
/**
 * Check if a given object implements the CreateAlertRule201Response interface.
 */
export function instanceOfCreateAlertRule201Response(value: object): value is CreateAlertRule201Response {
    return true;
}

export function CreateAlertRule201ResponseFromJSON(json: any): CreateAlertRule201Response {
    return CreateAlertRule201ResponseFromJSONTyped(json, false);
}

export function CreateAlertRule201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateAlertRule201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rule': json['rule'] == null ? undefined : AlertRuleFromJSON(json['rule']),
    };
}

export function CreateAlertRule201ResponseToJSON(json: any): CreateAlertRule201Response {
    return CreateAlertRule201ResponseToJSONTyped(json, false);
}

export function CreateAlertRule201ResponseToJSONTyped(value?: CreateAlertRule201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'rule': AlertRuleToJSON(value['rule']),
    };
}
