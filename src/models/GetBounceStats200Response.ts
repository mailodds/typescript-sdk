 ...
 * 
 * @export
 * @interface GetBounceStats200Response
 */
export interface GetBounceStats200Response {
    /**
     * 
     * @type {string}
...
/**
 * Check if a given object implements the GetBounceStats200Response interface.
 */
export function instanceOfGetBounceStats200Response(value: object): value is GetBounceStats200Response {
    return true;
}

export function GetBounceStats200ResponseFromJSON(json: any): GetBounceStats200Response {
    return GetBounceStats200ResponseFromJSONTyped(json, false);
}

export function GetBounceStats200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetBounceStats200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetBounceStats200ResponseToJSON(json: any): GetBounceStats200Response {
    return GetBounceStats200ResponseToJSONTyped(json, false);
}

export function GetBounceStats200ResponseToJSONTyped(value?: GetBounceStats200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
