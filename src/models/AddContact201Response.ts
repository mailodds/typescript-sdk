 ...
 * 
 * @export
 * @interface AddContact201Response
 */
export interface AddContact201Response {
    /**
     * 
     * @type {string}
     * @memberof AddContact201Response
     */
...
/**
 * Check if a given object implements the AddContact201Response interface.
 */
export function instanceOfAddContact201Response(value: object): value is AddContact201Response {
    return true;
}

export function AddContact201ResponseFromJSON(json: any): AddContact201Response {
    return AddContact201ResponseFromJSONTyped(json, false);
}

export function AddContact201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddContact201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AddContact201ResponseToJSON(json: any): AddContact201Response {
    return AddContact201ResponseToJSONTyped(json, false);
}

export function AddContact201ResponseToJSONTyped(value?: AddContact201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
