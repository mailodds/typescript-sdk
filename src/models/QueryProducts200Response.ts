...
import {
    ProductFacetsFromJSON,
    ProductFacetsFromJSONTyped,
    ProductFacetsToJSON,
    ProductFacetsToJSONTyped,
} from './ProductFacets';
 ...
 * 
 * @export
 * @interface QueryProducts200Response
 */
export interface QueryProducts200Response {
    /**
     * 
     * @type {string}
     * @memberof QueryProducts200Response
     */
...
/**
 * Check if a given object implements the QueryProducts200Response interface.
 */
export function instanceOfQueryProducts200Response(value: object): value is QueryProducts200Response {
    return true;
}

export function QueryProducts200ResponseFromJSON(json: any): QueryProducts200Response {
    return QueryProducts200ResponseFromJSONTyped(json, false);
}

export function QueryProducts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryProducts200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'products': json['products'] == null ? undefined : ((json['products'] as Array<any>).map(StoreProductFromJSON)),
        'total': json['total'] == null ? undefined : json['total'],
        'page': json['page'] == null ? undefined : json['page'],
        'perPage': json['per_page'] == null ? undefined : json['per_page'],
        'pages': json['pages'] == null ? undefined : json['pages'],
        'facets': json['facets'] == null ? undefined : ProductFacetsFromJSON(json['facets']),
    };
}

export function QueryProducts200ResponseToJSON(json: any): QueryProducts200Response {
    return QueryProducts200ResponseToJSONTyped(json, false);
}

export function QueryProducts200ResponseToJSONTyped(value?: QueryProducts200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'products': value['products'] == null ? undefined : ((value['products'] as Array<any>).map(StoreProductToJSON)),
        'total': value['total'],
        'page': value['page'],
        'per_page': value['perPage'],
        'pages': value['pages'],
        'facets': ProductFacetsToJSON(value['facets']),
    };
}
