 ...
 * 
 * @export
 * @interface SuppressDisengaged200Response
 */
export interface SuppressDisengaged200Response {
    /**
     * 
     * @type {string}
     * @memberof SuppressDisengaged200Response
     */
...
/**
 * Check if a given object implements the SuppressDisengaged200Response interface.
 */
export function instanceOfSuppressDisengaged200Response(value: object): value is SuppressDisengaged200Response {
    return true;
}

export function SuppressDisengaged200ResponseFromJSON(json: any): SuppressDisengaged200Response {
    return SuppressDisengaged200ResponseFromJSONTyped(json, false);
}

export function SuppressDisengaged200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuppressDisengaged200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function SuppressDisengaged200ResponseToJSON(json: any): SuppressDisengaged200Response {
    return SuppressDisengaged200ResponseToJSONTyped(json, false);
}

export function SuppressDisengaged200ResponseToJSONTyped(value?: SuppressDisengaged200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
