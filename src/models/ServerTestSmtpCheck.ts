 ...
 * 
 * @export
 * @interface ServerTestSmtpCheck
 */
export interface ServerTestSmtpCheck {
    /**
     * 
     * @type {boolean}
     * @memberof ServerTestSmtpCheck
     */
    connectable?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the ServerTestSmtpCheck interface.
 */
export function instanceOfServerTestSmtpCheck(value: object): value is ServerTestSmtpCheck {
    return true;
}

export function ServerTestSmtpCheckFromJSON(json: any): ServerTestSmtpCheck {
    return ServerTestSmtpCheckFromJSONTyped(json, false);
}

export function ServerTestSmtpCheckFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerTestSmtpCheck {
    if (json == null) {
        return json;
    }
    return {
        
        'connectable': json['connectable'] == null ? undefined : json['connectable'],
...
export function ServerTestSmtpCheckToJSON(json: any): ServerTestSmtpCheck {
    return ServerTestSmtpCheckToJSONTyped(json, false);
}

export function ServerTestSmtpCheckToJSONTyped(value?: ServerTestSmtpCheck | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
