 ...
 * 
 * @export
 * @interface SuppressDisengagedRequest
 */
export interface SuppressDisengagedRequest {
    /**
     * Days of inactivity threshold
     * @type {number}
     * @memberof SuppressDisengagedRequest
     */
    inactiveDays?: number;
    /**
...
/**
 * Check if a given object implements the SuppressDisengagedRequest interface.
 */
export function instanceOfSuppressDisengagedRequest(value: object): value is SuppressDisengagedRequest {
    return true;
}

export function SuppressDisengagedRequestFromJSON(json: any): SuppressDisengagedRequest {
    return SuppressDisengagedRequestFromJSONTyped(json, false);
}

export function SuppressDisengagedRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuppressDisengagedRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'inactiveDays': json['inactive_days'] == null ? undefined : json['inactive_days'],
        'minSends': json['min_sends'] == null ? undefined : json['min_sends'],
        'dryRun': json['dry_run'] == null ? undefined : json['dry_run'],
    };
}

export function SuppressDisengagedRequestToJSON(json: any): SuppressDisengagedRequest {
    return SuppressDisengagedRequestToJSONTyped(json, false);
}

export function SuppressDisengagedRequestToJSONTyped(value?: SuppressDisengagedRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'inactive_days': value['inactiveDays'],
        'min_sends': value['minSends'],
