...
import {
    AlertRuleFromJSON,
    AlertRuleFromJSONTyped,
    AlertRuleToJSON,
    AlertRuleToJSONTyped,
} from './AlertRule';

/**
 * 
 * @export
 * @interface ListAlertRules200Response
 */
export interface ListAlertRules200Response {
    /**
     * 
     * @type {string}
     * @memberof ListAlertRules200Response
     */
...
/**
 * Check if a given object implements the ListAlertRules200Response interface.
 */
export function instanceOfListAlertRules200Response(value: object): value is ListAlertRules200Response {
    return true;
}

export function ListAlertRules200ResponseFromJSON(json: any): ListAlertRules200Response {
    return ListAlertRules200ResponseFromJSONTyped(json, false);
}

export function ListAlertRules200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListAlertRules200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rules': json['rules'] == null ? undefined : ((json['rules'] as Array<any>).map(AlertRuleFromJSON)),
    };
}

export function ListAlertRules200ResponseToJSON(json: any): ListAlertRules200Response {
    return ListAlertRules200ResponseToJSONTyped(json, false);
}

export function ListAlertRules200ResponseToJSONTyped(value?: ListAlertRules200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'rules': value['rules'] == null ? undefined : ((value['rules'] as Array<any>).map(AlertRuleToJSON)),
    };
}
