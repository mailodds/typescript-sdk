 ...
 * 
 * @export
 * @interface GetInactiveContactsReport200ResponseByListInner
 */
export interface GetInactiveContactsReport200ResponseByListInner {
    /**
     * 
     * @type {string}
     * @memberof GetInactiveContactsReport200ResponseByListInner
     */
    listId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetInactiveContactsReport200ResponseByListInner interface.
 */
export function instanceOfGetInactiveContactsReport200ResponseByListInner(value: object): value is GetInactiveContactsReport200ResponseByListInner {
    return true;
}

export function GetInactiveContactsReport200ResponseByListInnerFromJSON(json: any): GetInactiveContactsReport200ResponseByListInner {
    return GetInactiveContactsReport200ResponseByListInnerFromJSONTyped(json, false);
}

export function GetInactiveContactsReport200ResponseByListInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetInactiveContactsReport200ResponseByListInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'listName': json['list_name'] == null ? undefined : json['list_name'],
        'inactiveCount': json['inactive_count'] == null ? undefined : json['inactive_count'],
        'total': json['total'] == null ? undefined : json['total'],
    };
}

export function GetInactiveContactsReport200ResponseByListInnerToJSON(json: any): GetInactiveContactsReport200ResponseByListInner {
    return GetInactiveContactsReport200ResponseByListInnerToJSONTyped(json, false);
}

export function GetInactiveContactsReport200ResponseByListInnerToJSONTyped(value?: GetInactiveContactsReport200ResponseByListInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
