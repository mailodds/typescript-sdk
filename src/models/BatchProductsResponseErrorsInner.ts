 ...
 * 
 * @export
 * @interface BatchProductsResponseErrorsInner
 */
export interface BatchProductsResponseErrorsInner {
    /**
     * 
     * @type {string}
     * @memberof BatchProductsResponseErrorsInner
     */
    externalId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BatchProductsResponseErrorsInner interface.
 */
export function instanceOfBatchProductsResponseErrorsInner(value: object): value is BatchProductsResponseErrorsInner {
    return true;
}

export function BatchProductsResponseErrorsInnerFromJSON(json: any): BatchProductsResponseErrorsInner {
    return BatchProductsResponseErrorsInnerFromJSONTyped(json, false);
}

export function BatchProductsResponseErrorsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchProductsResponseErrorsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function BatchProductsResponseErrorsInnerToJSON(json: any): BatchProductsResponseErrorsInner {
    return BatchProductsResponseErrorsInnerToJSONTyped(json, false);
}

export function BatchProductsResponseErrorsInnerToJSONTyped(value?: BatchProductsResponseErrorsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
