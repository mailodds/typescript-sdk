...
import type { GetDmarcRecommendation200ResponseRecommendation } from './GetDmarcRecommendation200ResponseRecommendation';
import {
    GetDmarcRecommendation200ResponseRecommendationFromJSON,
    GetDmarcRecommendation200ResponseRecommendationFromJSONTyped,
    GetDmarcRecommendation200ResponseRecommendationToJSON,
    GetDmarcRecommendation200ResponseRecommendationToJSONTyped,
} from './GetDmarcRecommendation200ResponseRecommendation';

/**
 * 
 * @export
 * @interface GetDmarcRecommendation200Response
 */
export interface GetDmarcRecommendation200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDmarcRecommendation200Response
     */
    ...
    /**
     * 
     * @type {GetDmarcRecommendation200ResponseRecommendation}
     * @memberof GetDmarcRecommendation200Response
     */
    recommendation?: GetDmarcRecommendation200ResponseRecommendation;
}

/**
 * Check if a given object implements the GetDmarcRecommendation200Response interface.
 */
export function instanceOfGetDmarcRecommendation200Response(value: object): value is GetDmarcRecommendation200Response {
    return true;
}

export function GetDmarcRecommendation200ResponseFromJSON(json: any): GetDmarcRecommendation200Response {
    return GetDmarcRecommendation200ResponseFromJSONTyped(json, false);
}

export function GetDmarcRecommendation200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDmarcRecommendation200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'recommendation': json['recommendation'] == null ? undefined : GetDmarcRecommendation200ResponseRecommendationFromJSON(json['recommendation']),
    };
}

export function GetDmarcRecommendation200ResponseToJSON(json: any): GetDmarcRecommendation200Response {
    return GetDmarcRecommendation200ResponseToJSONTyped(json, false);
}

export function GetDmarcRecommendation200ResponseToJSONTyped(value?: GetDmarcRecommendation200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'recommendation': GetDmarcRecommendation200ResponseRecommendationToJSON(value['recommendation']),
    };
}
