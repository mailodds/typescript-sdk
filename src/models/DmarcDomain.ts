...
/**
 * Check if a given object implements the DmarcDomain interface.
 */
export function instanceOfDmarcDomain(value: object): value is DmarcDomain {
    return true;
}

export function DmarcDomainFromJSON(json: any): DmarcDomain {
    return DmarcDomainFromJSONTyped(json, false);
}

export function DmarcDomainFromJSONTyped(json: any, ignoreDiscriminator: boolean): DmarcDomain {
    if (json == null) {
        return json;
    }
    return {
...
export function DmarcDomainToJSON(json: any): DmarcDomain {
    return DmarcDomainToJSONTyped(json, false);
}

export function DmarcDomainToJSONTyped(value?: DmarcDomain | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
