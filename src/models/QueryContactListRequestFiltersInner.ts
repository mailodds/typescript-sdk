 ...
 * 
 * @export
 * @interface QueryContactListRequestFiltersInner
 */
export interface QueryContactListRequestFiltersInner {
    /**
     * Field to filter on
     * @type {string}
     * @memberof QueryContactListRequestFiltersInner
     */
    field?: string;
    /**
     * 
     ...
     * @memberof QueryContactListRequestFiltersInner
     */
    operator?: QueryContactListRequestFiltersInnerOperatorEnum;
    /**
     * Filter value
     * @type {any}
     * @memberof QueryContactListRequestFiltersInner
 ...
 * @export
 */
export const QueryContactListRequestFiltersInnerOperatorEnum = {
    Eq: 'eq',
    Neq: 'neq',
    Contains: 'contains',
    In: 'in'
} as const;
export type QueryContactListRequestFiltersInnerOperatorEnum = typeof QueryContactListRequestFiltersInnerOperatorEnum[keyof typeof QueryContactListRequestFiltersInnerOperatorEnum];


/**
 * Check if a given object implements the QueryContactListRequestFiltersInner interface.
 */
export function instanceOfQueryContactListRequestFiltersInner(value: object): value is QueryContactListRequestFiltersInner {
    return true;
}

export function QueryContactListRequestFiltersInnerFromJSON(json: any): QueryContactListRequestFiltersInner {
    return QueryContactListRequestFiltersInnerFromJSONTyped(json, false);
}

export function QueryContactListRequestFiltersInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryContactListRequestFiltersInner {
    if (json == null) {
        return json;
    }
    return {
...
export function QueryContactListRequestFiltersInnerToJSON(json: any): QueryContactListRequestFiltersInner {
    return QueryContactListRequestFiltersInnerToJSONTyped(json, false);
}

export function QueryContactListRequestFiltersInnerToJSONTyped(value?: QueryContactListRequestFiltersInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
