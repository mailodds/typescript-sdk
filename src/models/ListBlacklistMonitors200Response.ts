 ...
 * 
 * @export
 * @interface ListBlacklistMonitors200Response
 */
export interface ListBlacklistMonitors200Response {
    /**
     * 
     * @type {string}
     * @memberof ListBlacklistMonitors200Response
     */
    ...
    /**
     * 
     * @type {Array<BlacklistMonitor>}
     * @memberof ListBlacklistMonitors200Response
     */
    monitors?: Array<BlacklistMonitor>;
}

/**
 * Check if a given object implements the ListBlacklistMonitors200Response interface.
 */
export function instanceOfListBlacklistMonitors200Response(value: object): value is ListBlacklistMonitors200Response {
    return true;
}

export function ListBlacklistMonitors200ResponseFromJSON(json: any): ListBlacklistMonitors200Response {
    return ListBlacklistMonitors200ResponseFromJSONTyped(json, false);
}

export function ListBlacklistMonitors200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListBlacklistMonitors200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'monitors': json['monitors'] == null ? undefined : ((json['monitors'] as Array<any>).map(BlacklistMonitorFromJSON)),
    };
}

export function ListBlacklistMonitors200ResponseToJSON(json: any): ListBlacklistMonitors200Response {
    return ListBlacklistMonitors200ResponseToJSONTyped(json, false);
}

export function ListBlacklistMonitors200ResponseToJSONTyped(value?: ListBlacklistMonitors200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'monitors': value['monitors'] == null ? undefined : ((value['monitors'] as Array<any>).map(BlacklistMonitorToJSON)),
    };
}
