 ...
 * 
 * @export
 * @interface UpdatePixelSettingsRequest
 */
export interface UpdatePixelSettingsRequest {
    /**
     * Contact list ID for pixel subscriptions, or null to disable
     * @type {number}
     * @memberof UpdatePixelSettingsRequest
     */
    pixelSubscribeListId: number | null;
}

/**
 * Check if a given object implements the UpdatePixelSettingsRequest interface.
 */
export function instanceOfUpdatePixelSettingsRequest(value: object): value is UpdatePixelSettingsRequest {
    if (!('pixelSubscribeListId' in value) || value['pixelSubscribeListId'] === undefined) return false;
    return true;
}

export function UpdatePixelSettingsRequestFromJSON(json: any): UpdatePixelSettingsRequest {
    return UpdatePixelSettingsRequestFromJSONTyped(json, false);
}

export function UpdatePixelSettingsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdatePixelSettingsRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'pixelSubscribeListId': json['pixel_subscribe_list_id'],
    };
}

export function UpdatePixelSettingsRequestToJSON(json: any): UpdatePixelSettingsRequest {
    return UpdatePixelSettingsRequestToJSONTyped(json, false);
}

export function UpdatePixelSettingsRequestToJSONTyped(value?: UpdatePixelSettingsRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
