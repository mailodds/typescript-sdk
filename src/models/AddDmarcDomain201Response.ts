 ...
 * 
 * @export
 * @interface AddDmarcDomain201Response
 */
export interface AddDmarcDomain201Response {
    /**
     * 
     * @type {string}
     * @memberof AddDmarcDomain201Response
     */
...
/**
 * Check if a given object implements the AddDmarcDomain201Response interface.
 */
export function instanceOfAddDmarcDomain201Response(value: object): value is AddDmarcDomain201Response {
    return true;
}

export function AddDmarcDomain201ResponseFromJSON(json: any): AddDmarcDomain201Response {
    return AddDmarcDomain201ResponseFromJSONTyped(json, false);
}

export function AddDmarcDomain201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddDmarcDomain201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'domain': json['domain'] == null ? undefined : DmarcDomainFromJSON(json['domain']),
    };
}

export function AddDmarcDomain201ResponseToJSON(json: any): AddDmarcDomain201Response {
    return AddDmarcDomain201ResponseToJSONTyped(json, false);
}

export function AddDmarcDomain201ResponseToJSONTyped(value?: AddDmarcDomain201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'domain': DmarcDomainToJSON(value['domain']),
    };
}
