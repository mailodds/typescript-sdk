 ...
 * 
 * @export
 * @interface GetEngagementScore200Response
 */
export interface GetEngagementScore200Response {
    /**
     * 
     * @type {string}
     * @memberof GetEngagementScore200Response
     */
...
/**
 * Check if a given object implements the GetEngagementScore200Response interface.
 */
export function instanceOfGetEngagementScore200Response(value: object): value is GetEngagementScore200Response {
    return true;
}

export function GetEngagementScore200ResponseFromJSON(json: any): GetEngagementScore200Response {
    return GetEngagementScore200ResponseFromJSONTyped(json, false);
}

export function GetEngagementScore200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetEngagementScore200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'lastEngagedAt': json['last_engaged_at'] == null ? undefined : (new Date(json['last_engaged_at'])),
    };
}

export function GetEngagementScore200ResponseToJSON(json: any): GetEngagementScore200Response {
    return GetEngagementScore200ResponseToJSONTyped(json, false);
}

export function GetEngagementScore200ResponseToJSONTyped(value?: GetEngagementScore200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'email': value['email'],
        'score': value['score'],
        'last_engaged_at': value['lastEngagedAt'] == null ? value['lastEngagedAt'] : value['lastEngagedAt'].toISOString(),
    };
}
