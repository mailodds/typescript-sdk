 ...
 * @export
 * @interface BounceAnalysisResponseAnalysisCategories
 */
export interface BounceAnalysisResponseAnalysisCategories {
    /**
     * 
     * @type {number}
     * @memberof BounceAnalysisResponseAnalysisCategories
     */
...
/**
 * Check if a given object implements the BounceAnalysisResponseAnalysisCategories interface.
 */
export function instanceOfBounceAnalysisResponseAnalysisCategories(value: object): value is BounceAnalysisResponseAnalysisCategories {
    return true;
}

export function BounceAnalysisResponseAnalysisCategoriesFromJSON(json: any): BounceAnalysisResponseAnalysisCategories {
    return BounceAnalysisResponseAnalysisCategoriesFromJSONTyped(json, false);
}

export function BounceAnalysisResponseAnalysisCategoriesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BounceAnalysisResponseAnalysisCategories {
    if (json == null) {
        return json;
    }
    return {
        
        'invalidRecipient': json['invalid_recipient'] == null ? undefined : json['invalid_recipient'],
        'mailboxFull': json['mailbox_full'] == null ? undefined : json['mailbox_full'],
        'domainIssue': json['domain_issue'] == null ? undefined : json['domain_issue'],
        'policyRejection': json['policy_rejection'] == null ? undefined : json['policy_rejection'],
        'contentRejection': json['content_rejection'] == null ? undefined : json['content_rejection'],
        'other': json['other'] == null ? undefined : json['other'],
    };
}

export function BounceAnalysisResponseAnalysisCategoriesToJSON(json: any): BounceAnalysisResponseAnalysisCategories {
    return BounceAnalysisResponseAnalysisCategoriesToJSONTyped(json, false);
}

export function BounceAnalysisResponseAnalysisCategoriesToJSONTyped(value?: BounceAnalysisResponseAnalysisCategories | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'invalid_recipient': value['invalidRecipient'],
        'mailbox_full': value['mailboxFull'],
        'domain_issue': value['domainIssue'],
        'policy_rejection': value['policyRejection'],
        'content_rejection': value['contentRejection'],
        'other': value['other'],
    };
}
