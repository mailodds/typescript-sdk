 ...
 * 
 * @export
 * @interface ProductFacetsPriceRangesInner
 */
export interface ProductFacetsPriceRangesInner {
    /**
     * Price range label (e.g., '0-10', '500+')
     * @type {string}
     * @memberof ProductFacetsPriceRangesInner
     */
    range?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ProductFacetsPriceRangesInner interface.
 */
export function instanceOfProductFacetsPriceRangesInner(value: object): value is ProductFacetsPriceRangesInner {
    return true;
}

export function ProductFacetsPriceRangesInnerFromJSON(json: any): ProductFacetsPriceRangesInner {
    return ProductFacetsPriceRangesInnerFromJSONTyped(json, false);
}

export function ProductFacetsPriceRangesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductFacetsPriceRangesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductFacetsPriceRangesInnerToJSON(json: any): ProductFacetsPriceRangesInner {
    return ProductFacetsPriceRangesInnerToJSONTyped(json, false);
}

export function ProductFacetsPriceRangesInnerToJSONTyped(value?: ProductFacetsPriceRangesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
