...
import type { RunBlacklistCheck200ResponseCheck } from './RunBlacklistCheck200ResponseCheck';
import {
    RunBlacklistCheck200ResponseCheckFromJSON,
    RunBlacklistCheck200ResponseCheckFromJSONTyped,
    RunBlacklistCheck200ResponseCheckToJSON,
    RunBlacklistCheck200ResponseCheckToJSONTyped,
} from './RunBlacklistCheck200ResponseCheck';
import type { BlacklistMonitor } from './BlacklistMonitor';
import {
    BlacklistMonitorFromJSON,
    BlacklistMonitorFromJSONTyped,
    BlacklistMonitorToJSON,
    BlacklistMonitorToJSONTyped,
} from './BlacklistMonitor';

/**
 * 
 * @export
 * @interface RunBlacklistCheck200Response
 */
export interface RunBlacklistCheck200Response {
    /**
     * 
     * @type {string}
     * @memberof RunBlacklistCheck200Response
     */
    ...
    /**
     * 
     * @type {RunBlacklistCheck200ResponseCheck}
     * @memberof RunBlacklistCheck200Response
     */
    check?: RunBlacklistCheck200ResponseCheck;
}

/**
 * Check if a given object implements the RunBlacklistCheck200Response interface.
 */
export function instanceOfRunBlacklistCheck200Response(value: object): value is RunBlacklistCheck200Response {
    return true;
}

export function RunBlacklistCheck200ResponseFromJSON(json: any): RunBlacklistCheck200Response {
    return RunBlacklistCheck200ResponseFromJSONTyped(json, false);
}

export function RunBlacklistCheck200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RunBlacklistCheck200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'monitor': json['monitor'] == null ? undefined : BlacklistMonitorFromJSON(json['monitor']),
        'check': json['check'] == null ? undefined : RunBlacklistCheck200ResponseCheckFromJSON(json['check']),
    };
}

export function RunBlacklistCheck200ResponseToJSON(json: any): RunBlacklistCheck200Response {
    return RunBlacklistCheck200ResponseToJSONTyped(json, false);
}

export function RunBlacklistCheck200ResponseToJSONTyped(value?: RunBlacklistCheck200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'monitor': BlacklistMonitorToJSON(value['monitor']),
        'check': RunBlacklistCheck200ResponseCheckToJSON(value['check']),
    };
}
