 ...
 * 
 * @export
 * @interface DisconnectStore200Response
 */
export interface DisconnectStore200Response {
    /**
     * 
     * @type {string}
     * @memberof DisconnectStore200Response
     */
...
/**
 * Check if a given object implements the DisconnectStore200Response interface.
 */
export function instanceOfDisconnectStore200Response(value: object): value is DisconnectStore200Response {
    return true;
}

export function DisconnectStore200ResponseFromJSON(json: any): DisconnectStore200Response {
    return DisconnectStore200ResponseFromJSONTyped(json, false);
}

export function DisconnectStore200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DisconnectStore200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DisconnectStore200ResponseToJSON(json: any): DisconnectStore200Response {
    return DisconnectStore200ResponseToJSONTyped(json, false);
}

export function DisconnectStore200ResponseToJSONTyped(value?: DisconnectStore200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
