...
import type { QueryContactListRequestFiltersInner } from './QueryContactListRequestFiltersInner';
import {
    QueryContactListRequestFiltersInnerFromJSON,
    QueryContactListRequestFiltersInnerFromJSONTyped,
    QueryContactListRequestFiltersInnerToJSON,
    QueryContactListRequestFiltersInnerToJSONTyped,
} from './QueryContactListRequestFiltersInner';

/**
 * 
 * @export
 * @interface QueryContactListRequest
 */
export interface QueryContactListRequest {
    /**
     * Array of filter conditions
     * @type {Array<QueryContactListRequestFiltersInner>}
     * @memberof QueryContactListRequest
     */
    filters?: Array<QueryContactListRequestFiltersInner>;
    /**
     * 
     * @type {number}
     * @memberof QueryContactListRequest
...
/**
 * Check if a given object implements the QueryContactListRequest interface.
 */
export function instanceOfQueryContactListRequest(value: object): value is QueryContactListRequest {
    return true;
}

export function QueryContactListRequestFromJSON(json: any): QueryContactListRequest {
    return QueryContactListRequestFromJSONTyped(json, false);
}

export function QueryContactListRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryContactListRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'filters': json['filters'] == null ? undefined : ((json['filters'] as Array<any>).map(QueryContactListRequestFiltersInnerFromJSON)),
        'page': json['page'] == null ? undefined : json['page'],
        'perPage': json['per_page'] == null ? undefined : json['per_page'],
    };
}

export function QueryContactListRequestToJSON(json: any): QueryContactListRequest {
    return QueryContactListRequestToJSONTyped(json, false);
}

export function QueryContactListRequestToJSONTyped(value?: QueryContactListRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'filters': value['filters'] == null ? undefined : ((value['filters'] as Array<any>).map(QueryContactListRequestFiltersInnerToJSON)),
        'page': value['page'],
