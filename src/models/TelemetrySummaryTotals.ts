...
/**
 * Check if a given object implements the TelemetrySummaryTotals interface.
 */
export function instanceOfTelemetrySummaryTotals(value: object): value is TelemetrySummaryTotals {
    return true;
}

export function TelemetrySummaryTotalsFromJSON(json: any): TelemetrySummaryTotals {
    return TelemetrySummaryTotalsFromJSONTyped(json, false);
}

export function TelemetrySummaryTotalsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TelemetrySummaryTotals {
    if (json == null) {
        return json;
    }
    return {
...
export function TelemetrySummaryTotalsToJSON(json: any): TelemetrySummaryTotals {
    return TelemetrySummaryTotalsToJSONTyped(json, false);
}

export function TelemetrySummaryTotalsToJSONTyped(value?: TelemetrySummaryTotals | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
