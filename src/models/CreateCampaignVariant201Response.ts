 ...
 * 
 * @export
 * @interface CreateCampaignVariant201Response
 */
export interface CreateCampaignVariant201Response {
    /**
     * 
     * @type {string}
     * @memberof CreateCampaignVariant201Response
     */
...
/**
 * Check if a given object implements the CreateCampaignVariant201Response interface.
 */
export function instanceOfCreateCampaignVariant201Response(value: object): value is CreateCampaignVariant201Response {
    return true;
}

export function CreateCampaignVariant201ResponseFromJSON(json: any): CreateCampaignVariant201Response {
    return CreateCampaignVariant201ResponseFromJSONTyped(json, false);
}

export function CreateCampaignVariant201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCampaignVariant201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'variant': json['variant'] == null ? undefined : CampaignVariantFromJSON(json['variant']),
    };
}

export function CreateCampaignVariant201ResponseToJSON(json: any): CreateCampaignVariant201Response {
    return CreateCampaignVariant201ResponseToJSONTyped(json, false);
}

export function CreateCampaignVariant201ResponseToJSONTyped(value?: CreateCampaignVariant201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'variant': CampaignVariantToJSON(value['variant']),
    };
}
