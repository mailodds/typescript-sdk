 ...
 * 
 * @export
 * @interface ProductFacetsStoresInner
 */
export interface ProductFacetsStoresInner {
    /**
     * 
     * @type {string}
     * @memberof ProductFacetsStoresInner
     */
    storeId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ProductFacetsStoresInner interface.
 */
export function instanceOfProductFacetsStoresInner(value: object): value is ProductFacetsStoresInner {
    return true;
}

export function ProductFacetsStoresInnerFromJSON(json: any): ProductFacetsStoresInner {
    return ProductFacetsStoresInnerFromJSONTyped(json, false);
}

export function ProductFacetsStoresInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductFacetsStoresInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductFacetsStoresInnerToJSON(json: any): ProductFacetsStoresInner {
    return ProductFacetsStoresInnerToJSONTyped(json, false);
}

export function ProductFacetsStoresInnerToJSONTyped(value?: ProductFacetsStoresInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
