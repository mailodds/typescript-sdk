 ...
 * 
 * @export
 * @interface QueryContactList200ResponseEmailsInner
 */
export interface QueryContactList200ResponseEmailsInner {
    /**
     * 
     * @type {string}
     * @memberof QueryContactList200ResponseEmailsInner
     */
    email?: string;
    /**
     * 
...
/**
 * Check if a given object implements the QueryContactList200ResponseEmailsInner interface.
 */
export function instanceOfQueryContactList200ResponseEmailsInner(value: object): value is QueryContactList200ResponseEmailsInner {
    return true;
}

export function QueryContactList200ResponseEmailsInnerFromJSON(json: any): QueryContactList200ResponseEmailsInner {
    return QueryContactList200ResponseEmailsInnerFromJSONTyped(json, false);
}

export function QueryContactList200ResponseEmailsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryContactList200ResponseEmailsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function QueryContactList200ResponseEmailsInnerToJSON(json: any): QueryContactList200ResponseEmailsInner {
    return QueryContactList200ResponseEmailsInnerToJSONTyped(json, false);
}

export function QueryContactList200ResponseEmailsInnerToJSONTyped(value?: QueryContactList200ResponseEmailsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
