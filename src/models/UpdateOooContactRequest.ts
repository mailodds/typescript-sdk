 ...
 * 
 * @export
 * @interface UpdateOooContactRequest
 */
export interface UpdateOooContactRequest {
    /**
     * Set to false to clear OOO status
     * @type {boolean}
     * @memberof UpdateOooContactRequest
     */
    isActive?: boolean;
    /**
     * 
...
/**
 * Check if a given object implements the UpdateOooContactRequest interface.
 */
export function instanceOfUpdateOooContactRequest(value: object): value is UpdateOooContactRequest {
    return true;
}

export function UpdateOooContactRequestFromJSON(json: any): UpdateOooContactRequest {
    return UpdateOooContactRequestFromJSONTyped(json, false);
}

export function UpdateOooContactRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateOooContactRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateOooContactRequestToJSON(json: any): UpdateOooContactRequest {
    return UpdateOooContactRequestToJSONTyped(json, false);
}

export function UpdateOooContactRequestToJSONTyped(value?: UpdateOooContactRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
