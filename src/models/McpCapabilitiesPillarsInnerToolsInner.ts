 ...
 * 
 * @export
 * @interface McpCapabilitiesPillarsInnerToolsInner
 */
export interface McpCapabilitiesPillarsInnerToolsInner {
    /**
     * 
     * @type {string}
     * @memberof McpCapabilitiesPillarsInnerToolsInner
     */
    name?: string;
    /**
...
/**
 * Check if a given object implements the McpCapabilitiesPillarsInnerToolsInner interface.
 */
export function instanceOfMcpCapabilitiesPillarsInnerToolsInner(value: object): value is McpCapabilitiesPillarsInnerToolsInner {
    return true;
}

export function McpCapabilitiesPillarsInnerToolsInnerFromJSON(json: any): McpCapabilitiesPillarsInnerToolsInner {
    return McpCapabilitiesPillarsInnerToolsInnerFromJSONTyped(json, false);
}

export function McpCapabilitiesPillarsInnerToolsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): McpCapabilitiesPillarsInnerToolsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'requiredScope': json['required_scope'] == null ? undefined : json['required_scope'],
    };
}

export function McpCapabilitiesPillarsInnerToolsInnerToJSON(json: any): McpCapabilitiesPillarsInnerToolsInner {
    return McpCapabilitiesPillarsInnerToolsInnerToJSONTyped(json, false);
}

export function McpCapabilitiesPillarsInnerToolsInnerToJSONTyped(value?: McpCapabilitiesPillarsInnerToolsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'name': value['name'],
        'required_scope': value['requiredScope'],
    };
}
