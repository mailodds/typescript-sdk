 ...
 * 
 * @export
 * @interface DeleteOooContact200Response
 */
export interface DeleteOooContact200Response {
    /**
     * 
     * @type {boolean}
     * @memberof DeleteOooContact200Response
     */
    cleared?: boolean;
}

/**
 * Check if a given object implements the DeleteOooContact200Response interface.
 */
export function instanceOfDeleteOooContact200Response(value: object): value is DeleteOooContact200Response {
    return true;
}

export function DeleteOooContact200ResponseFromJSON(json: any): DeleteOooContact200Response {
    return DeleteOooContact200ResponseFromJSONTyped(json, false);
}

export function DeleteOooContact200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeleteOooContact200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function DeleteOooContact200ResponseToJSON(json: any): DeleteOooContact200Response {
    return DeleteOooContact200ResponseToJSONTyped(json, false);
}

export function DeleteOooContact200ResponseToJSONTyped(value?: DeleteOooContact200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
