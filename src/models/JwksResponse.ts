...
import type { JwksResponseKeysInner } from './JwksResponseKeysInner';
import {
    JwksResponseKeysInnerFromJSON,
    JwksResponseKeysInnerFromJSONTyped,
    JwksResponseKeysInnerToJSON,
    JwksResponseKeysInnerToJSONTyped,
} from './JwksResponseKeysInner';
...
export interface JwksResponse {
    /**
     * 
     * @type {Array<JwksResponseKeysInner>}
     * @memberof JwksResponse
     */
    keys?: Array<JwksResponseKeysInner>;
}
...
export function JwksResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): JwksResponse {
    ...
    return {
        ...
        'keys': json['keys'] == null ? undefined : ((json['keys'] as Array<any>).map(JwksResponseKeysInnerFromJSON)),
    };
}
...
export function JwksResponseToJSONTyped(value?: JwksResponse | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'keys': value['keys'] == null ? undefined : ((value['keys'] as Array<any>).map(JwksResponseKeysInnerToJSON)),
    };
}
