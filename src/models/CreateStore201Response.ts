...
import {
    StoreConnectionFromJSON,
    StoreConnectionFromJSONTyped,
    StoreConnectionToJSON,
    StoreConnectionToJSONTyped,
} from './StoreConnection';

/**
 * 
 * @export
 * @interface CreateStore201Response
 */
export interface CreateStore201Response {
    /**
     * 
     * @type {string}
     * @memberof CreateStore201Response
     */
...
/**
 * Check if a given object implements the CreateStore201Response interface.
 */
export function instanceOfCreateStore201Response(value: object): value is CreateStore201Response {
    return true;
}

export function CreateStore201ResponseFromJSON(json: any): CreateStore201Response {
    return CreateStore201ResponseFromJSONTyped(json, false);
}

export function CreateStore201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateStore201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'store': json['store'] == null ? undefined : StoreConnectionFromJSON(json['store']),
    };
}

export function CreateStore201ResponseToJSON(json: any): CreateStore201Response {
    return CreateStore201ResponseToJSONTyped(json, false);
}

export function CreateStore201ResponseToJSONTyped(value?: CreateStore201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'store': StoreConnectionToJSON(value['store']),
    };
}
