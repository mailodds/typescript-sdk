 ...
 * 
 * @export
 * @interface DeliverRequestOptions
 */
export interface DeliverRequestOptions {
    /**
     * Validate recipients before sending
     * @type {boolean}
     * @memberof DeliverRequestOptions
     */
    validateFirst?: boolean;
}

/**
 * Check if a given object implements the DeliverRequestOptions interface.
 */
export function instanceOfDeliverRequestOptions(value: object): value is DeliverRequestOptions {
    return true;
}

export function DeliverRequestOptionsFromJSON(json: any): DeliverRequestOptions {
    return DeliverRequestOptionsFromJSONTyped(json, false);
}

export function DeliverRequestOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeliverRequestOptions {
    if (json == null) {
        return json;
    }
    return {
        
        'validateFirst': json['validate_first'] == null ? undefined : json['validate_first'],
    };
}

export function DeliverRequestOptionsToJSON(json: any): DeliverRequestOptions {
    return DeliverRequestOptionsToJSONTyped(json, false);
}

export function DeliverRequestOptionsToJSONTyped(value?: DeliverRequestOptions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'validate_first': value['validateFirst'],
    };
}
