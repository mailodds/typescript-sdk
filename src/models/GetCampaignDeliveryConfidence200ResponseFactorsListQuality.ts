 ...
 * 
 * @export
 * @interface GetCampaignDeliveryConfidence200ResponseFactorsListQuality
 */
export interface GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    /**
     * 
     * @type {number}
     * @memberof GetCampaignDeliveryConfidence200ResponseFactorsListQuality
     */
    score?: number;
    /**
     * 
...
/**
 * Check if a given object implements the GetCampaignDeliveryConfidence200ResponseFactorsListQuality interface.
 */
export function instanceOfGetCampaignDeliveryConfidence200ResponseFactorsListQuality(value: object): value is GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    return true;
}

export function GetCampaignDeliveryConfidence200ResponseFactorsListQualityFromJSON(json: any): GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    return GetCampaignDeliveryConfidence200ResponseFactorsListQualityFromJSONTyped(json, false);
}

export function GetCampaignDeliveryConfidence200ResponseFactorsListQualityFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    if (json == null) {
        return json;
    }
    return {
        ...
        'totalRecipients': json['total_recipients'] == null ? undefined : json['total_recipients'],
        'validatedPct': json['validated_pct'] == null ? undefined : json['validated_pct'],
        'suppressedCount': json['suppressed_count'] == null ? undefined : json['suppressed_count'],
    };
}

export function GetCampaignDeliveryConfidence200ResponseFactorsListQualityToJSON(json: any): GetCampaignDeliveryConfidence200ResponseFactorsListQuality {
    return GetCampaignDeliveryConfidence200ResponseFactorsListQualityToJSONTyped(json, false);
}

export function GetCampaignDeliveryConfidence200ResponseFactorsListQualityToJSONTyped(value?: GetCampaignDeliveryConfidence200ResponseFactorsListQuality | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'validated_pct': value['validatedPct'],
