 ...
 * 
 * @export
 * @interface ListInboundMessages200Response
 */
export interface ListInboundMessages200Response {
    /**
     * 
     * @type {string}
     * @memberof ListInboundMessages200Response
     */
...
/**
 * Check if a given object implements the ListInboundMessages200Response interface.
 */
export function instanceOfListInboundMessages200Response(value: object): value is ListInboundMessages200Response {
    return true;
}

export function ListInboundMessages200ResponseFromJSON(json: any): ListInboundMessages200Response {
    return ListInboundMessages200ResponseFromJSONTyped(json, false);
}

export function ListInboundMessages200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListInboundMessages200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ListInboundMessages200ResponseToJSON(json: any): ListInboundMessages200Response {
    return ListInboundMessages200ResponseToJSONTyped(json, false);
}

export function ListInboundMessages200ResponseToJSONTyped(value?: ListInboundMessages200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
