 ...
 * 
 * @export
 * @interface AppendToContactListRequest
 */
export interface AppendToContactListRequest {
    /**
     * Validation job IDs to append from
     * @type {Array<string>}
     * @memberof AppendToContactListRequest
     */
...
/**
 * Check if a given object implements the AppendToContactListRequest interface.
 */
export function instanceOfAppendToContactListRequest(value: object): value is AppendToContactListRequest {
    if (!('sourceJobIds' in value) || value['sourceJobIds'] === undefined) return false;
    return true;
}

export function AppendToContactListRequestFromJSON(json: any): AppendToContactListRequest {
    return AppendToContactListRequestFromJSONTyped(json, false);
}

export function AppendToContactListRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppendToContactListRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'sourceJobIds': json['source_job_ids'],
        'includeCatchAll': json['include_catch_all'] == null ? undefined : json['include_catch_all'],
    };
}

export function AppendToContactListRequestToJSON(json: any): AppendToContactListRequest {
    return AppendToContactListRequestToJSONTyped(json, false);
}

export function AppendToContactListRequestToJSONTyped(value?: AppendToContactListRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'include_catch_all': value['includeCatchAll'],
    };
}
