...
import type { QueryContactList200ResponseEmailsInner } from './QueryContactList200ResponseEmailsInner';
import {
    QueryContactList200ResponseEmailsInnerFromJSON,
    QueryContactList200ResponseEmailsInnerFromJSONTyped,
    QueryContactList200ResponseEmailsInnerToJSON,
    QueryContactList200ResponseEmailsInnerToJSONTyped,
} from './QueryContactList200ResponseEmailsInner';

/**
 * 
 * @export
 * @interface QueryContactList200Response
 */
export interface QueryContactList200Response {
    /**
     * 
     * @type {string}
     * @memberof QueryContactList200Response
     */
    ...
    /**
     * 
     * @type {Array<QueryContactList200ResponseEmailsInner>}
     * @memberof QueryContactList200Response
     */
    emails?: Array<QueryContactList200ResponseEmailsInner>;
    /**
     * 
     * @type {number}
     * @memberof QueryContactList200Response
...
/**
 * Check if a given object implements the QueryContactList200Response interface.
 */
export function instanceOfQueryContactList200Response(value: object): value is QueryContactList200Response {
    return true;
}

export function QueryContactList200ResponseFromJSON(json: any): QueryContactList200Response {
    return QueryContactList200ResponseFromJSONTyped(json, false);
}

export function QueryContactList200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): QueryContactList200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'emails': json['emails'] == null ? undefined : ((json['emails'] as Array<any>).map(QueryContactList200ResponseEmailsInnerFromJSON)),
...
export function QueryContactList200ResponseToJSON(json: any): QueryContactList200Response {
    return QueryContactList200ResponseToJSONTyped(json, false);
}

export function QueryContactList200ResponseToJSONTyped(value?: QueryContactList200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'emails': value['emails'] == null ? undefined : ((value['emails'] as Array<any>).map(QueryContactList200ResponseEmailsInnerToJSON)),
        'total': value['total'],
        'page': value['page'],
