 ...
 * 
 * @export
 * @interface GetSyncJobErrors200Response
 */
export interface GetSyncJobErrors200Response {
    /**
     * 
     * @type {string}
     * @memberof GetSyncJobErrors200Response
     */
...
/**
 * Check if a given object implements the GetSyncJobErrors200Response interface.
 */
export function instanceOfGetSyncJobErrors200Response(value: object): value is GetSyncJobErrors200Response {
    return true;
}

export function GetSyncJobErrors200ResponseFromJSON(json: any): GetSyncJobErrors200Response {
    return GetSyncJobErrors200ResponseFromJSONTyped(json, false);
}

export function GetSyncJobErrors200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSyncJobErrors200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetSyncJobErrors200ResponseToJSON(json: any): GetSyncJobErrors200Response {
    return GetSyncJobErrors200ResponseToJSONTyped(json, false);
}

export function GetSyncJobErrors200ResponseToJSONTyped(value?: GetSyncJobErrors200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
