...
import type { McpCapabilitiesPillarsInnerToolsInner } from './McpCapabilitiesPillarsInnerToolsInner';
import {
    McpCapabilitiesPillarsInnerToolsInnerFromJSON,
    McpCapabilitiesPillarsInnerToolsInnerFromJSONTyped,
    McpCapabilitiesPillarsInnerToolsInnerToJSON,
    McpCapabilitiesPillarsInnerToolsInnerToJSONTyped,
} from './McpCapabilitiesPillarsInnerToolsInner';

/**
 * 
 * @export
 * @interface McpCapabilitiesPillarsInner
 */
export interface McpCapabilitiesPillarsInner {
    /**
     * 
     * @type {string}
     * @memberof McpCapabilitiesPillarsInner
     */
    name?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<McpCapabilitiesPillarsInnerToolsInner>}
     * @memberof McpCapabilitiesPillarsInner
     */
    tools?: Array<McpCapabilitiesPillarsInnerToolsInner>;
}

/**
 * Check if a given object implements the McpCapabilitiesPillarsInner interface.
 */
export function instanceOfMcpCapabilitiesPillarsInner(value: object): value is McpCapabilitiesPillarsInner {
    return true;
}

export function McpCapabilitiesPillarsInnerFromJSON(json: any): McpCapabilitiesPillarsInner {
    return McpCapabilitiesPillarsInnerFromJSONTyped(json, false);
}

export function McpCapabilitiesPillarsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): McpCapabilitiesPillarsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'tools': json['tools'] == null ? undefined : ((json['tools'] as Array<any>).map(McpCapabilitiesPillarsInnerToolsInnerFromJSON)),
    };
}

export function McpCapabilitiesPillarsInnerToJSON(json: any): McpCapabilitiesPillarsInner {
    return McpCapabilitiesPillarsInnerToJSONTyped(json, false);
}

export function McpCapabilitiesPillarsInnerToJSONTyped(value?: McpCapabilitiesPillarsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'tools': value['tools'] == null ? undefined : ((value['tools'] as Array<any>).map(McpCapabilitiesPillarsInnerToolsInnerToJSON)),
    };
}
