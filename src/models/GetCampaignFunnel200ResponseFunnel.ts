 ...
 * 
 * @export
 * @interface GetCampaignFunnel200ResponseFunnel
 */
export interface GetCampaignFunnel200ResponseFunnel {
    /**
     * 
     * @type {number}
     * @memberof GetCampaignFunnel200ResponseFunnel
     */
    sent?: number;
    /**
     * 
...
/**
 * Check if a given object implements the GetCampaignFunnel200ResponseFunnel interface.
 */
export function instanceOfGetCampaignFunnel200ResponseFunnel(value: object): value is GetCampaignFunnel200ResponseFunnel {
    return true;
}

export function GetCampaignFunnel200ResponseFunnelFromJSON(json: any): GetCampaignFunnel200ResponseFunnel {
    return GetCampaignFunnel200ResponseFunnelFromJSONTyped(json, false);
}

export function GetCampaignFunnel200ResponseFunnelFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignFunnel200ResponseFunnel {
    if (json == null) {
        return json;
    }
    return {
...
export function GetCampaignFunnel200ResponseFunnelToJSON(json: any): GetCampaignFunnel200ResponseFunnel {
    return GetCampaignFunnel200ResponseFunnelToJSONTyped(json, false);
}

export function GetCampaignFunnel200ResponseFunnelToJSONTyped(value?: GetCampaignFunnel200ResponseFunnel | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
