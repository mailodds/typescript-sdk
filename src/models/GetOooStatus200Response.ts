 ...
 * 
 * @export
 * @interface GetOooStatus200Response
 */
export interface GetOooStatus200Response {
    /**
     * 
     * @type {string}
     * @memberof GetOooStatus200Response
     */
    email?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetOooStatus200Response interface.
 */
export function instanceOfGetOooStatus200Response(value: object): value is GetOooStatus200Response {
    return true;
}

export function GetOooStatus200ResponseFromJSON(json: any): GetOooStatus200Response {
    return GetOooStatus200ResponseFromJSONTyped(json, false);
}

export function GetOooStatus200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetOooStatus200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'oooType': json['ooo_type'] == null ? undefined : json['ooo_type'],
    };
}

export function GetOooStatus200ResponseToJSON(json: any): GetOooStatus200Response {
    return GetOooStatus200ResponseToJSONTyped(json, false);
}

export function GetOooStatus200ResponseToJSONTyped(value?: GetOooStatus200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
