 ...
 * 
 * @export
 * @interface GetBlacklistHistory200ResponseChecksInner
 */
export interface GetBlacklistHistory200ResponseChecksInner {
    /**
     * 
     * @type {string}
     * @memberof GetBlacklistHistory200ResponseChecksInner
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetBlacklistHistory200ResponseChecksInner interface.
 */
export function instanceOfGetBlacklistHistory200ResponseChecksInner(value: object): value is GetBlacklistHistory200ResponseChecksInner {
    return true;
}

export function GetBlacklistHistory200ResponseChecksInnerFromJSON(json: any): GetBlacklistHistory200ResponseChecksInner {
    return GetBlacklistHistory200ResponseChecksInnerFromJSONTyped(json, false);
}

export function GetBlacklistHistory200ResponseChecksInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetBlacklistHistory200ResponseChecksInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'listedOn': json['listed_on'] == null ? undefined : json['listed_on'],
        'cleanOn': json['clean_on'] == null ? undefined : json['clean_on'],
        'checkedAt': json['checked_at'] == null ? undefined : (new Date(json['checked_at'])),
    };
}

export function GetBlacklistHistory200ResponseChecksInnerToJSON(json: any): GetBlacklistHistory200ResponseChecksInner {
    return GetBlacklistHistory200ResponseChecksInnerToJSONTyped(json, false);
}

export function GetBlacklistHistory200ResponseChecksInnerToJSONTyped(value?: GetBlacklistHistory200ResponseChecksInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'id': value['id'],
        'listed_on': value['listedOn'],
        'clean_on': value['cleanOn'],
        'checked_at': value['checkedAt'] == null ? value['checkedAt'] : value['checkedAt'].toISOString(),
    };
}
