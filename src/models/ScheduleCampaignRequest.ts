...
/**
 * Check if a given object implements the ScheduleCampaignRequest interface.
 */
export function instanceOfScheduleCampaignRequest(value: object): value is ScheduleCampaignRequest {
    if (!('sendAt' in value) || value['sendAt'] === undefined) return false;
    return true;
}

export function ScheduleCampaignRequestFromJSON(json: any): ScheduleCampaignRequest {
    return ScheduleCampaignRequestFromJSONTyped(json, false);
}

export function ScheduleCampaignRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleCampaignRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ScheduleCampaignRequestToJSON(json: any): ScheduleCampaignRequest {
    return ScheduleCampaignRequestToJSONTyped(json, false);
}

export function ScheduleCampaignRequestToJSONTyped(value?: ScheduleCampaignRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
