 ...
 * 
 * @export
 * @interface CreateWebhookCliSessionRequest
 */
export interface CreateWebhookCliSessionRequest {
    /**
     * Local URL where webhooks will be forwarded
     * @type {string}
     * @memberof CreateWebhookCliSessionRequest
     */
    forwardUrl?: string;
}

/**
 * Check if a given object implements the CreateWebhookCliSessionRequest interface.
 */
export function instanceOfCreateWebhookCliSessionRequest(value: object): value is CreateWebhookCliSessionRequest {
    return true;
}

export function CreateWebhookCliSessionRequestFromJSON(json: any): CreateWebhookCliSessionRequest {
    return CreateWebhookCliSessionRequestFromJSONTyped(json, false);
}

export function CreateWebhookCliSessionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateWebhookCliSessionRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'forwardUrl': json['forward_url'] == null ? undefined : json['forward_url'],
    };
}

export function CreateWebhookCliSessionRequestToJSON(json: any): CreateWebhookCliSessionRequest {
    return CreateWebhookCliSessionRequestToJSONTyped(json, false);
}

export function CreateWebhookCliSessionRequestToJSONTyped(value?: CreateWebhookCliSessionRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
