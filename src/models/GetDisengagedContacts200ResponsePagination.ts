 ...
 * 
 * @export
 * @interface GetDisengagedContacts200ResponsePagination
 */
export interface GetDisengagedContacts200ResponsePagination {
    /**
     * 
     * @type {number}
     * @memberof GetDisengagedContacts200ResponsePagination
     */
    page?: number;
    /**
     * 
...
/**
 * Check if a given object implements the GetDisengagedContacts200ResponsePagination interface.
 */
export function instanceOfGetDisengagedContacts200ResponsePagination(value: object): value is GetDisengagedContacts200ResponsePagination {
    return true;
}

export function GetDisengagedContacts200ResponsePaginationFromJSON(json: any): GetDisengagedContacts200ResponsePagination {
    return GetDisengagedContacts200ResponsePaginationFromJSONTyped(json, false);
}

export function GetDisengagedContacts200ResponsePaginationFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDisengagedContacts200ResponsePagination {
    if (json == null) {
        return json;
    }
    return {
...
export function GetDisengagedContacts200ResponsePaginationToJSON(json: any): GetDisengagedContacts200ResponsePagination {
    return GetDisengagedContacts200ResponsePaginationToJSONTyped(json, false);
}

export function GetDisengagedContacts200ResponsePaginationToJSONTyped(value?: GetDisengagedContacts200ResponsePagination | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
