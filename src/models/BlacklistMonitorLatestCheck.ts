 ...
 * 
 * @export
 * @interface BlacklistMonitorLatestCheck
 */
export interface BlacklistMonitorLatestCheck {
    /**
     * 
     * @type {string}
     * @memberof BlacklistMonitorLatestCheck
     */
    id?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BlacklistMonitorLatestCheck interface.
 */
export function instanceOfBlacklistMonitorLatestCheck(value: object): value is BlacklistMonitorLatestCheck {
    return true;
}

export function BlacklistMonitorLatestCheckFromJSON(json: any): BlacklistMonitorLatestCheck {
    return BlacklistMonitorLatestCheckFromJSONTyped(json, false);
}

export function BlacklistMonitorLatestCheckFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlacklistMonitorLatestCheck {
    if (json == null) {
        return json;
    }
    return {
...
export function BlacklistMonitorLatestCheckToJSON(json: any): BlacklistMonitorLatestCheck {
    return BlacklistMonitorLatestCheckToJSONTyped(json, false);
}

export function BlacklistMonitorLatestCheckToJSONTyped(value?: BlacklistMonitorLatestCheck | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
