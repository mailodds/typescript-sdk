...
/**
 * Check if a given object implements the JwksResponseKeysInner interface.
 */
export function instanceOfJwksResponseKeysInner(value: object): value is JwksResponseKeysInner {
    return true;
}

export function JwksResponseKeysInnerFromJSON(json: any): JwksResponseKeysInner {
    return JwksResponseKeysInnerFromJSONTyped(json, false);
}

export function JwksResponseKeysInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): JwksResponseKeysInner {
    if (json == null) {
        return json;
    }
    return {
...
export function JwksResponseKeysInnerToJSON(json: any): JwksResponseKeysInner {
    return JwksResponseKeysInnerToJSONTyped(json, false);
}

export function JwksResponseKeysInnerToJSONTyped(value?: JwksResponseKeysInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
