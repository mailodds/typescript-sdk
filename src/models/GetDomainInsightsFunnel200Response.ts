 ...
 * 
 * @export
 * @interface GetDomainInsightsFunnel200Response
 */
export interface GetDomainInsightsFunnel200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDomainInsightsFunnel200Response
     */
...
/**
 * Check if a given object implements the GetDomainInsightsFunnel200Response interface.
 */
export function instanceOfGetDomainInsightsFunnel200Response(value: object): value is GetDomainInsightsFunnel200Response {
    return true;
}

export function GetDomainInsightsFunnel200ResponseFromJSON(json: any): GetDomainInsightsFunnel200Response {
    return GetDomainInsightsFunnel200ResponseFromJSONTyped(json, false);
}

export function GetDomainInsightsFunnel200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDomainInsightsFunnel200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'funnel': json['funnel'] == null ? undefined : json['funnel'],
    };
}

export function GetDomainInsightsFunnel200ResponseToJSON(json: any): GetDomainInsightsFunnel200Response {
    return GetDomainInsightsFunnel200ResponseToJSONTyped(json, false);
}

export function GetDomainInsightsFunnel200ResponseToJSONTyped(value?: GetDomainInsightsFunnel200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
