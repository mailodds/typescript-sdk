...
import type { GetDmarcSources200ResponseSourcesInner } from './GetDmarcSources200ResponseSourcesInner';
import {
    GetDmarcSources200ResponseSourcesInnerFromJSON,
    GetDmarcSources200ResponseSourcesInnerFromJSONTyped,
    GetDmarcSources200ResponseSourcesInnerToJSON,
    GetDmarcSources200ResponseSourcesInnerToJSONTyped,
} from './GetDmarcSources200ResponseSourcesInner';
 ...
 * 
 * @export
 * @interface GetDmarcSources200Response
 */
export interface GetDmarcSources200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDmarcSources200Response
     */
    ...
    /**
     * 
     * @type {Array<GetDmarcSources200ResponseSourcesInner>}
     * @memberof GetDmarcSources200Response
     */
    sources?: Array<GetDmarcSources200ResponseSourcesInner>;
    /**
     * 
     * @type {Pagination}
     * @memberof GetDmarcSources200Response
...
/**
 * Check if a given object implements the GetDmarcSources200Response interface.
 */
export function instanceOfGetDmarcSources200Response(value: object): value is GetDmarcSources200Response {
    return true;
}

export function GetDmarcSources200ResponseFromJSON(json: any): GetDmarcSources200Response {
    return GetDmarcSources200ResponseFromJSONTyped(json, false);
}

export function GetDmarcSources200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDmarcSources200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sources': json['sources'] == null ? undefined : ((json['sources'] as Array<any>).map(GetDmarcSources200ResponseSourcesInnerFromJSON)),
        'pagination': json['pagination'] == null ? undefined : PaginationFromJSON(json['pagination']),
    };
}

export function GetDmarcSources200ResponseToJSON(json: any): GetDmarcSources200Response {
    return GetDmarcSources200ResponseToJSONTyped(json, false);
}

export function GetDmarcSources200ResponseToJSONTyped(value?: GetDmarcSources200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sources': value['sources'] == null ? undefined : ((value['sources'] as Array<any>).map(GetDmarcSources200ResponseSourcesInnerToJSON)),
