 ...
 * 
 * @export
 * @interface GetReputationTimeline200Response
 */
export interface GetReputationTimeline200Response {
    /**
     * 
     * @type {string}
...
/**
 * Check if a given object implements the GetReputationTimeline200Response interface.
 */
export function instanceOfGetReputationTimeline200Response(value: object): value is GetReputationTimeline200Response {
    return true;
}

export function GetReputationTimeline200ResponseFromJSON(json: any): GetReputationTimeline200Response {
    return GetReputationTimeline200ResponseFromJSONTyped(json, false);
}

export function GetReputationTimeline200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReputationTimeline200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetReputationTimeline200ResponseToJSON(json: any): GetReputationTimeline200Response {
    return GetReputationTimeline200ResponseToJSONTyped(json, false);
}

export function GetReputationTimeline200ResponseToJSONTyped(value?: GetReputationTimeline200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
