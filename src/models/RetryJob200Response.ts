 ...
 * 
 * @export
 * @interface RetryJob200Response
 */
export interface RetryJob200Response {
    /**
     * 
     * @type {string}
     * @memberof RetryJob200Response
     */
...
/**
 * Check if a given object implements the RetryJob200Response interface.
 */
export function instanceOfRetryJob200Response(value: object): value is RetryJob200Response {
    return true;
}

export function RetryJob200ResponseFromJSON(json: any): RetryJob200Response {
    return RetryJob200ResponseFromJSONTyped(json, false);
}

export function RetryJob200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RetryJob200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function RetryJob200ResponseToJSON(json: any): RetryJob200Response {
    return RetryJob200ResponseToJSONTyped(json, false);
}

export function RetryJob200ResponseToJSONTyped(value?: RetryJob200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
