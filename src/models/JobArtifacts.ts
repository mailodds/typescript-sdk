...
/**
 * Check if a given object implements the JobArtifacts interface.
 */
export function instanceOfJobArtifacts(value: object): value is JobArtifacts {
    return true;
}

export function JobArtifactsFromJSON(json: any): JobArtifacts {
    return JobArtifactsFromJSONTyped(json, false);
}

export function JobArtifactsFromJSONTyped(json: any, ignoreDiscriminator: boolean): JobArtifacts {
    if (json == null) {
        return json;
    }
    return {
        
        'csvAll': json['csv_all'] == null ? undefined : json['csv_all'],
        'csvValid': json['csv_valid'] == null ? undefined : json['csv_valid'],
        'csvInvalid': json['csv_invalid'] == null ? undefined : json['csv_invalid'],
    };
}

export function JobArtifactsToJSON(json: any): JobArtifacts {
    return JobArtifactsToJSONTyped(json, false);
}

export function JobArtifactsToJSONTyped(value?: JobArtifacts | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'csv_all': value['csvAll'],
        'csv_valid': value['csvValid'],
        'csv_invalid': value['csvInvalid'],
    };
}
