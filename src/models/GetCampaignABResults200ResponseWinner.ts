 ...
 * @export
 * @interface GetCampaignABResults200ResponseWinner
 */
export interface GetCampaignABResults200ResponseWinner {
    /**
     * 
     * @type {string}
     * @memberof GetCampaignABResults200ResponseWinner
     */
    variantId?: string;
    /**
...
/**
 * Check if a given object implements the GetCampaignABResults200ResponseWinner interface.
 */
export function instanceOfGetCampaignABResults200ResponseWinner(value: object): value is GetCampaignABResults200ResponseWinner {
    return true;
}

export function GetCampaignABResults200ResponseWinnerFromJSON(json: any): GetCampaignABResults200ResponseWinner {
    return GetCampaignABResults200ResponseWinnerFromJSONTyped(json, false);
}

export function GetCampaignABResults200ResponseWinnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignABResults200ResponseWinner {
    if (json == null) {
        return json;
    }
    return {
...
export function GetCampaignABResults200ResponseWinnerToJSON(json: any): GetCampaignABResults200ResponseWinner {
    return GetCampaignABResults200ResponseWinnerToJSONTyped(json, false);
}

export function GetCampaignABResults200ResponseWinnerToJSONTyped(value?: GetCampaignABResults200ResponseWinner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
