...
import type { GetDisengagedContacts200ResponsePagination } from './GetDisengagedContacts200ResponsePagination';
import {
    GetDisengagedContacts200ResponsePaginationFromJSON,
    GetDisengagedContacts200ResponsePaginationFromJSONTyped,
    GetDisengagedContacts200ResponsePaginationToJSON,
    GetDisengagedContacts200ResponsePaginationToJSONTyped,
} from './GetDisengagedContacts200ResponsePagination';

/**
 * 
 * @export
 * @interface GetDisengagedContacts200Response
 */
export interface GetDisengagedContacts200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDisengagedContacts200Response
     */
    ...
    /**
     * 
     * @type {GetDisengagedContacts200ResponsePagination}
     * @memberof GetDisengagedContacts200Response
     */
    pagination?: GetDisengagedContacts200ResponsePagination;
}

/**
 * Check if a given object implements the GetDisengagedContacts200Response interface.
 */
export function instanceOfGetDisengagedContacts200Response(value: object): value is GetDisengagedContacts200Response {
    return true;
}

export function GetDisengagedContacts200ResponseFromJSON(json: any): GetDisengagedContacts200Response {
    return GetDisengagedContacts200ResponseFromJSONTyped(json, false);
}

export function GetDisengagedContacts200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDisengagedContacts200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'pagination': json['pagination'] == null ? undefined : GetDisengagedContacts200ResponsePaginationFromJSON(json['pagination']),
    };
}

export function GetDisengagedContacts200ResponseToJSON(json: any): GetDisengagedContacts200Response {
    return GetDisengagedContacts200ResponseToJSONTyped(json, false);
}

export function GetDisengagedContacts200ResponseToJSONTyped(value?: GetDisengagedContacts200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': value['data'],
        'pagination': GetDisengagedContacts200ResponsePaginationToJSON(value['pagination']),
    };
}
