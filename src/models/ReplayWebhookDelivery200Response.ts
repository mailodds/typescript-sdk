 ...
 * 
 * @export
 * @interface ReplayWebhookDelivery200Response
 */
export interface ReplayWebhookDelivery200Response {
    /**
     * 
     * @type {string}
     * @memberof ReplayWebhookDelivery200Response
     */
    status?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ReplayWebhookDelivery200Response interface.
 */
export function instanceOfReplayWebhookDelivery200Response(value: object): value is ReplayWebhookDelivery200Response {
    return true;
}

export function ReplayWebhookDelivery200ResponseFromJSON(json: any): ReplayWebhookDelivery200Response {
    return ReplayWebhookDelivery200ResponseFromJSONTyped(json, false);
}

export function ReplayWebhookDelivery200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReplayWebhookDelivery200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ReplayWebhookDelivery200ResponseToJSON(json: any): ReplayWebhookDelivery200Response {
    return ReplayWebhookDelivery200ResponseToJSONTyped(json, false);
}

export function ReplayWebhookDelivery200ResponseToJSONTyped(value?: ReplayWebhookDelivery200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
