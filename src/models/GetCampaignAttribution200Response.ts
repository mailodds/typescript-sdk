...
import type { GetCampaignAttribution200ResponseAttribution } from './GetCampaignAttribution200ResponseAttribution';
import {
    GetCampaignAttribution200ResponseAttributionFromJSON,
    GetCampaignAttribution200ResponseAttributionFromJSONTyped,
    GetCampaignAttribution200ResponseAttributionToJSON,
    GetCampaignAttribution200ResponseAttributionToJSONTyped,
} from './GetCampaignAttribution200ResponseAttribution';

/**
 * 
 * @export
 * @interface GetCampaignAttribution200Response
 */
export interface GetCampaignAttribution200Response {
    /**
     * 
     * @type {string}
     * @memberof GetCampaignAttribution200Response
     */
    ...
    /**
     * 
     * @type {GetCampaignAttribution200ResponseAttribution}
     * @memberof GetCampaignAttribution200Response
     */
    attribution?: GetCampaignAttribution200ResponseAttribution;
}

/**
 * Check if a given object implements the GetCampaignAttribution200Response interface.
 */
export function instanceOfGetCampaignAttribution200Response(value: object): value is GetCampaignAttribution200Response {
    return true;
}

export function GetCampaignAttribution200ResponseFromJSON(json: any): GetCampaignAttribution200Response {
    return GetCampaignAttribution200ResponseFromJSONTyped(json, false);
}

export function GetCampaignAttribution200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetCampaignAttribution200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'attribution': json['attribution'] == null ? undefined : GetCampaignAttribution200ResponseAttributionFromJSON(json['attribution']),
    };
}

export function GetCampaignAttribution200ResponseToJSON(json: any): GetCampaignAttribution200Response {
    return GetCampaignAttribution200ResponseToJSONTyped(json, false);
}

export function GetCampaignAttribution200ResponseToJSONTyped(value?: GetCampaignAttribution200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'attribution': GetCampaignAttribution200ResponseAttributionToJSON(value['attribution']),
    };
}
