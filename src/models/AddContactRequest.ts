...
/**
 * Check if a given object implements the AddContactRequest interface.
 */
export function instanceOfAddContactRequest(value: object): value is AddContactRequest {
...
export function AddContactRequestToJSON(json: any): AddContactRequest {
    return AddContactRequestToJSONTyped(json, false);
}

export function AddContactRequestToJSONTyped(value?: AddContactRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
