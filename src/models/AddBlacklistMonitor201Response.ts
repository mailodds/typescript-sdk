 ...
 * 
 * @export
 * @interface AddBlacklistMonitor201Response
 */
export interface AddBlacklistMonitor201Response {
    /**
     * 
     * @type {string}
     * @memberof AddBlacklistMonitor201Response
     */
...
/**
 * Check if a given object implements the AddBlacklistMonitor201Response interface.
 */
export function instanceOfAddBlacklistMonitor201Response(value: object): value is AddBlacklistMonitor201Response {
    return true;
}

export function AddBlacklistMonitor201ResponseFromJSON(json: any): AddBlacklistMonitor201Response {
    return AddBlacklistMonitor201ResponseFromJSONTyped(json, false);
}

export function AddBlacklistMonitor201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddBlacklistMonitor201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AddBlacklistMonitor201ResponseToJSON(json: any): AddBlacklistMonitor201Response {
    return AddBlacklistMonitor201ResponseToJSONTyped(json, false);
}

export function AddBlacklistMonitor201ResponseToJSONTyped(value?: AddBlacklistMonitor201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
