...
import type { SuppressionAuditResponseEntriesInner } from './SuppressionAuditResponseEntriesInner';
import {
    SuppressionAuditResponseEntriesInnerFromJSON,
    SuppressionAuditResponseEntriesInnerFromJSONTyped,
    SuppressionAuditResponseEntriesInnerToJSON,
    SuppressionAuditResponseEntriesInnerToJSONTyped,
} from './SuppressionAuditResponseEntriesInner';

/**
 * 
 * @export
 * @interface SuppressionAuditResponse
 */
export interface SuppressionAuditResponse {
    /**
     * 
     * @type {string}
     * @memberof SuppressionAuditResponse
     */
    ...
    /**
     * 
     * @type {Array<SuppressionAuditResponseEntriesInner>}
     * @memberof SuppressionAuditResponse
     */
    entries?: Array<SuppressionAuditResponseEntriesInner>;
    /**
     * 
     * @type {Pagination}
     * @memberof SuppressionAuditResponse
...
/**
 * Check if a given object implements the SuppressionAuditResponse interface.
 */
export function instanceOfSuppressionAuditResponse(value: object): value is SuppressionAuditResponse {
    return true;
}

export function SuppressionAuditResponseFromJSON(json: any): SuppressionAuditResponse {
    return SuppressionAuditResponseFromJSONTyped(json, false);
}

export function SuppressionAuditResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuppressionAuditResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'entries': json['entries'] == null ? undefined : ((json['entries'] as Array<any>).map(SuppressionAuditResponseEntriesInnerFromJSON)),
        'pagination': json['pagination'] == null ? undefined : PaginationFromJSON(json['pagination']),
    };
}

export function SuppressionAuditResponseToJSON(json: any): SuppressionAuditResponse {
    return SuppressionAuditResponseToJSONTyped(json, false);
}

export function SuppressionAuditResponseToJSONTyped(value?: SuppressionAuditResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'entries': value['entries'] == null ? undefined : ((value['entries'] as Array<any>).map(SuppressionAuditResponseEntriesInnerToJSON)),
