...
import type { GetDmarcDomain200ResponseDomain } from './GetDmarcDomain200ResponseDomain';
import {
    GetDmarcDomain200ResponseDomainFromJSON,
    GetDmarcDomain200ResponseDomainFromJSONTyped,
    GetDmarcDomain200ResponseDomainToJSON,
    GetDmarcDomain200ResponseDomainToJSONTyped,
} from './GetDmarcDomain200ResponseDomain';

/**
 * 
 * @export
 * @interface GetDmarcDomain200Response
 */
export interface GetDmarcDomain200Response {
    /**
     * 
     * @type {string}
     * @memberof GetDmarcDomain200Response
     */
    ...
    /**
     * 
     * @type {GetDmarcDomain200ResponseDomain}
     * @memberof GetDmarcDomain200Response
     */
    domain?: GetDmarcDomain200ResponseDomain;
}

/**
 * Check if a given object implements the GetDmarcDomain200Response interface.
 */
export function instanceOfGetDmarcDomain200Response(value: object): value is GetDmarcDomain200Response {
    return true;
}

export function GetDmarcDomain200ResponseFromJSON(json: any): GetDmarcDomain200Response {
    return GetDmarcDomain200ResponseFromJSONTyped(json, false);
}

export function GetDmarcDomain200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetDmarcDomain200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'domain': json['domain'] == null ? undefined : GetDmarcDomain200ResponseDomainFromJSON(json['domain']),
    };
}

export function GetDmarcDomain200ResponseToJSON(json: any): GetDmarcDomain200Response {
    return GetDmarcDomain200ResponseToJSONTyped(json, false);
}

export function GetDmarcDomain200ResponseToJSONTyped(value?: GetDmarcDomain200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'domain': GetDmarcDomain200ResponseDomainToJSON(value['domain']),
    };
}
