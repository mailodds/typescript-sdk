 ...
 * 
 * @export
 * @interface GetBounceStatsSummary200Response
 */
export interface GetBounceStatsSummary200Response {
    /**
     * 
     * @type {string}
     * @memberof GetBounceStatsSummary200Response
     */
...
/**
 * Check if a given object implements the GetBounceStatsSummary200Response interface.
 */
export function instanceOfGetBounceStatsSummary200Response(value: object): value is GetBounceStatsSummary200Response {
    return true;
}

export function GetBounceStatsSummary200ResponseFromJSON(json: any): GetBounceStatsSummary200Response {
    return GetBounceStatsSummary200ResponseFromJSONTyped(json, false);
}

export function GetBounceStatsSummary200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetBounceStatsSummary200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetBounceStatsSummary200ResponseToJSON(json: any): GetBounceStatsSummary200Response {
    return GetBounceStatsSummary200ResponseToJSONTyped(json, false);
}

export function GetBounceStatsSummary200ResponseToJSONTyped(value?: GetBounceStatsSummary200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
