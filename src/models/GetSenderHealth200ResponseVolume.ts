 ...
 * 
 * @export
 * @interface GetSenderHealth200ResponseVolume
 */
export interface GetSenderHealth200ResponseVolume {
    /**
     * 
     * @type {number}
     * @memberof GetSenderHealth200ResponseVolume
     */
    sent?: number;
    /**
     * 
...
/**
 * Check if a given object implements the GetSenderHealth200ResponseVolume interface.
 */
export function instanceOfGetSenderHealth200ResponseVolume(value: object): value is GetSenderHealth200ResponseVolume {
    return true;
}

export function GetSenderHealth200ResponseVolumeFromJSON(json: any): GetSenderHealth200ResponseVolume {
    return GetSenderHealth200ResponseVolumeFromJSONTyped(json, false);
}

export function GetSenderHealth200ResponseVolumeFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSenderHealth200ResponseVolume {
    if (json == null) {
        return json;
    }
    return {
...
export function GetSenderHealth200ResponseVolumeToJSON(json: any): GetSenderHealth200ResponseVolume {
    return GetSenderHealth200ResponseVolumeToJSONTyped(json, false);
}

export function GetSenderHealth200ResponseVolumeToJSONTyped(value?: GetSenderHealth200ResponseVolume | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
