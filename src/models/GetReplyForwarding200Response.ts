 ...
 * 
 * @export
 * @interface GetReplyForwarding200Response
 */
export interface GetReplyForwarding200Response {
    /**
     * 
     * @type {string}
     * @memberof GetReplyForwarding200Response
     */
    domainId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the GetReplyForwarding200Response interface.
 */
export function instanceOfGetReplyForwarding200Response(value: object): value is GetReplyForwarding200Response {
    return true;
}

export function GetReplyForwarding200ResponseFromJSON(json: any): GetReplyForwarding200Response {
    return GetReplyForwarding200ResponseFromJSONTyped(json, false);
}

export function GetReplyForwarding200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReplyForwarding200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function GetReplyForwarding200ResponseToJSON(json: any): GetReplyForwarding200Response {
    return GetReplyForwarding200ResponseToJSONTyped(json, false);
}

export function GetReplyForwarding200ResponseToJSONTyped(value?: GetReplyForwarding200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
