 ...
 * 
 * @export
 * @interface CreateContactList201Response
 */
export interface CreateContactList201Response {
    /**
     * 
     * @type {string}
     * @memberof CreateContactList201Response
     */
...
/**
 * Check if a given object implements the CreateContactList201Response interface.
 */
export function instanceOfCreateContactList201Response(value: object): value is CreateContactList201Response {
    return true;
}

export function CreateContactList201ResponseFromJSON(json: any): CreateContactList201Response {
    return CreateContactList201ResponseFromJSONTyped(json, false);
}

export function CreateContactList201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateContactList201Response {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateContactList201ResponseToJSON(json: any): CreateContactList201Response {
    return CreateContactList201ResponseToJSONTyped(json, false);
}

export function CreateContactList201ResponseToJSONTyped(value?: CreateContactList201Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
