 ...
 * 
 * @export
 * @interface CreateStorefrontDomainRequest
 */
export interface CreateStorefrontDomainRequest {
    /**
     * Fully qualified domain name
     * @type {string}
     * @memberof CreateStorefrontDomainRequest
     */
    fqdn: string;
    /**
     * Store connection ID
...
/**
 * Check if a given object implements the CreateStorefrontDomainRequest interface.
 */
export function instanceOfCreateStorefrontDomainRequest(value: object): value is CreateStorefrontDomainRequest {
    if (!('fqdn' in value) || value['fqdn'] === undefined) return false;
    if (!('storeId' in value) || value['storeId'] === undefined) return false;
    return true;
}

export function CreateStorefrontDomainRequestFromJSON(json: any): CreateStorefrontDomainRequest {
    return CreateStorefrontDomainRequestFromJSONTyped(json, false);
}

export function CreateStorefrontDomainRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateStorefrontDomainRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateStorefrontDomainRequestToJSON(json: any): CreateStorefrontDomainRequest {
    return CreateStorefrontDomainRequestToJSONTyped(json, false);
}

export function CreateStorefrontDomainRequestToJSONTyped(value?: CreateStorefrontDomainRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
