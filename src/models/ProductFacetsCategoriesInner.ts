 ...
 * 
 * @export
 * @interface ProductFacetsCategoriesInner
 */
export interface ProductFacetsCategoriesInner {
    /**
     * 
     * @type {string}
     * @memberof ProductFacetsCategoriesInner
     */
    name?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ProductFacetsCategoriesInner interface.
 */
export function instanceOfProductFacetsCategoriesInner(value: object): value is ProductFacetsCategoriesInner {
    return true;
}

export function ProductFacetsCategoriesInnerFromJSON(json: any): ProductFacetsCategoriesInner {
    return ProductFacetsCategoriesInnerFromJSONTyped(json, false);
}

export function ProductFacetsCategoriesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductFacetsCategoriesInner {
    if (json == null) {
        return json;
    }
    return {
...
export function ProductFacetsCategoriesInnerToJSON(json: any): ProductFacetsCategoriesInner {
    return ProductFacetsCategoriesInnerToJSONTyped(json, false);
}

export function ProductFacetsCategoriesInnerToJSONTyped(value?: ProductFacetsCategoriesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
